...
public class EPBlockUtil {
    ...
    public static List<ItemStack> getBlockDrops(
            ServerLevel level, BlockPos pos, Player player, Map<Enchantment, Integer> enchantments) {
    ...
    private static HarvestTool createHarvestTool(
            BlockState state, Map<Enchantment, Integer> enchantments) {
        ItemStack tool;
