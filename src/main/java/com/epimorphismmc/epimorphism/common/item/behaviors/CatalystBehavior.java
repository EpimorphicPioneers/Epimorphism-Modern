...
public class CatalystBehavior implements IItemComponent, IMODurabilityBar, IAddInformation {
    ...
    @Nullable protected CompoundTag getCatalystStatsTag(ItemStack itemStack) {
    ...
    public void appendHoverText(
            ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
    ...
    @Nullable public static CatalystBehavior getBehaviour(@NotNull ItemStack itemStack) {
