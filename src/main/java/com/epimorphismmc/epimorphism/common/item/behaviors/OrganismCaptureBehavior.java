...
import com.epimorphismmc.epimorphism.utils.EPTransformUtil;
...
public class OrganismCaptureBehavior implements IInteractionItem {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        return player != null && hasEntity(itemStack) && release(itemStack, level, blockPos, direction)
    ...
    private boolean release(
            ItemStack itemStack, Level level, BlockPos blockPos, Direction direction) {
    ...
    public static String getEntityName(ItemStack itemStack) {
        if (hasEntity(itemStack)) {
            return LocalizationUtils.format(new ResourceLocation(
                            "entity." + itemStack.getOrCreateTag().getString(OrganismCaptureBehavior.OC_ENTITY))
                    .toLanguageKey());
        }
