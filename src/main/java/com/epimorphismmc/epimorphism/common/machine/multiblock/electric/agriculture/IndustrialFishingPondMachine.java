package com.epimorphismmc.epimorphism.common.machine.multiblock.electric.agriculture;

import com.epimorphismmc.epimorphism.common.machine.trait.FishingPondRecipeLogic;
...
public class IndustrialFishingPondMachine extends ParallelElectricMultiblockMachine {
    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            IndustrialFishingPondMachine.class, ParallelElectricMultiblockMachine.MANAGED_FIELD_HOLDER);
    ...
    public void attachConfigurators(ConfiguratorPanel configuratorPanel) {
        configuratorPanel.attachConfigurators(new CustomModeFancyConfigurator(
                        ...
                        3,
                        "block.epimorphism.industrial_fishing_pond.fishing_mode.%s"::formatted,
                        this::getMode,
                        this::setMode)
                .setHasTooltips(true));
        ...
        if (this.isFormed()) {
            ...
            if (maxVoltage > 0L) {
                ...
                textList.add(Component.translatable(
                        "gtceu.multiblock.max_energy_per_tick", maxVoltage, voltageName));
            }

            textList.add(Component.translatable(
                            "block.epimorphism.industrial_fishing_pond.fishing_mode.%s".formatted(getMode()))
            ...
            if (!this.isFilledWater()) {
                textList.add(
                        Component.translatable("block.epimorphism.industrial_fishing_pond.warning.fill_water")
                                .setStyle(Style.EMPTY.withColor(ChatFormatting.RED)));
            }
        }
