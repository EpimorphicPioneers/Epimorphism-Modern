...
public class InfiniteWaterHatchPartMachine extends TieredIOPartMachine {
    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            InfiniteWaterHatchPartMachine.class, TieredIOPartMachine.MANAGED_FIELD_HOLDER);

    @Nullable protected TickableSubscription productSubs;
    ...
    protected void productWater() {
        boolean isFilled =
                tank.fillInternal(FluidStack.create(Fluids.WATER, Long.MAX_VALUE), false) == 0;
