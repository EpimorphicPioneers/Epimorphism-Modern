...
public class ReinforcedRotorHolderPartMachine extends TieredPartMachine
        implements IMachineModifyDrops, IReinforcedRotorHolder {

    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            ReinforcedRotorHolderPartMachine.class, TieredPartMachine.MANAGED_FIELD_HOLDER);
    ...
    @Nullable protected ISubscription rotorInvSubs;

    @Nullable protected ISubscription controllerChangedSubs;

    @Nullable protected ISubscription speedChangedSubs;
    ...
    public void onLoad() {
        ...
        if (!isRemote()) {
            ...
            controllerChangedSubs =
                    addSyncUpdateListener("controllerPositions", this::onControllerChanged);
        }
    }
