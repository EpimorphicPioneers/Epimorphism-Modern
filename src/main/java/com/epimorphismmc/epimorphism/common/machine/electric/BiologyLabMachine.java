package com.epimorphismmc.epimorphism.common.machine.electric;
...
public class BiologyLabMachine extends TieredEnergyMachine
        implements IAutoOutputItem, IFancyUIMachine, IMachineModifyDrops {
    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER =
            new ManagedFieldHolder(BiologyLabMachine.class, TieredEnergyMachine.MANAGED_FIELD_HOLDER);
