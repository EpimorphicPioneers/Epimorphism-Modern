...
public class NanoForgeMachine extends WorkableElectricMultiblockMachine
    ...
    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            NanoForgeMachine.class, WorkableElectricMultiblockMachine.MANAGED_FIELD_HOLDER);
    ...
    @Nullable private ISubscription nanitesChangedSubs;
    ...
    public static BlockPattern getBlockPattern(int tier, MachineDefinition definition) {
        var builder = FactoryMOPattern.start()
                ...
                .where('B', Predicates.blocks(EPBlocks.NAQUADAH_ALLOY_CASING.get()))
                .where(
                        'E',
                        Predicates.blocks(EPBlocks.NAQUADAH_ALLOY_CASING.get())
                                .or(autoAbilities(definition.getRecipeTypes()))
                                .or(autoAbilities(true, true, false)))
                .where('C', Predicates.frames(EPMaterials.StellarAlloy));
    ...
    public Widget createUIWidget() {
        ...
        if (widget instanceof WidgetGroup group) {
            ...
            group.addWidget(
                    new SlotWidget(nanitesStorage.storage, 0, size.width - 30, size.height - 30, true, true)
