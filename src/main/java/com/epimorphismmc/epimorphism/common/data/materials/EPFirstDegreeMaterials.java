    ...
    public static void register() {
        ...
        CubicBoronNitride = Builder("cubic_boron_nitride")
                ...
                .toolStats(new ToolProperty(
                        14.0F, 9.0F, 12400, 6, GTToolType.getTypes().values().toArray(GTToolType[]::new)))
                .buildAndRegister()
        ...
        //  24036 Iodized Brine
        IodizedBrine =
                Builder("iodized_brine").fluid().color(0x525246).buildAndRegister().setFormula("I?", false);
        ...
        //  24039 Iodine Slurry
        IodineSlurry =
                Builder("iodine_slurry").fluid().color(0x292923).buildAndRegister().setFormula("I?", false);
        //  24040 Sodium Iodate
        ...
        ChromiumGermaniumTelluride.getProperty(PropertyKey.INGOT)
                .setMagneticMaterial(ChromiumGermaniumTellurideMagnetic);
        ...
        MagnetoHydrodynamicallyConstrainedStarMatter = Builder(
                        "magneto_hydrodynamically_constrained_star_matter")
                .ingot()
        ...
        HeavyLeptonMixture = Builder("heavy_lepton_mixture")
                ...
                .buildAndRegister()
                .setFormula(
                        ChatFormatting.OBFUSCATED + "a" + ChatFormatting.RESET + "§e(t2)u"
                                + ChatFormatting.OBFUSCATED + "a",
                        true);
        //  24218 Heavy Quarks
        HeavyQuarks = Builder("heavy_quarks")
                ...
                .buildAndRegister()
                .setFormula(
                        ChatFormatting.OBFUSCATED + "a" + ChatFormatting.RESET + "§e(u2)ds"
                                + ChatFormatting.OBFUSCATED + "a",
                        true);
        //  24219 Gluons
        Gluons = Builder("gluons")
                ...
                .buildAndRegister()
                .setFormula(
                        ChatFormatting.OBFUSCATED + "a" + ChatFormatting.RESET + "§eg"
                                + ChatFormatting.OBFUSCATED + "a",
                        false);
        //  24220 Instantons
        Instantons = Builder("instantons")
                ...
                .buildAndRegister()
                .setFormula(
                        ChatFormatting.OBFUSCATED + "a" + ChatFormatting.RESET + "§ei"
                                + ChatFormatting.OBFUSCATED + "a",
                        false);
        ...
        TemporalFluid = Builder("temporal_fluid")
                ...
                .buildAndRegister()
                .setFormula(
                        ChatFormatting.OBFUSCATED + "a" + ChatFormatting.RESET + "§et"
                                + ChatFormatting.OBFUSCATED + "a",
                        false);
        //  24222 Higgs Bosons
        HiggsBosons = Builder("higgs_bosons")
                ...
                .buildAndRegister()
                .setFormula(
                        ChatFormatting.OBFUSCATED + "a" + ChatFormatting.RESET + "§eh"
                                + ChatFormatting.OBFUSCATED + "a",
                        false);
        ...
        FreeElectronGas = Builder("free_electron_gas")
                ...
                .buildAndRegister()
                .setFormula(
                        ChatFormatting.OBFUSCATED + "a" + ChatFormatting.RESET + "§ee"
                                + ChatFormatting.OBFUSCATED + "a",
                        false);
        ...
        QuarkGluonPlasma = Builder("quark_gluon_plasma")
                .fluid(
                        ...
                        new FluidBuilder()
                                .temperature((int) (GTValues.V[GTValues.ZPM] + GTValues.V[GTValues.UHV]) / 2))
                .color(HeavyQuarks.getMaterialRGB() + Gluons.getMaterialRGB())
                .buildAndRegister()
                .setFormula(
                        ChatFormatting.OBFUSCATED + "a" + ChatFormatting.RESET + "§e(u2)d(c2)s(t2)bg"
                                + ChatFormatting.OBFUSCATED + "a",
                        false);
        //  24243 Light Quarks
        LightQuarks = Builder("light_quarks")
                .fluid(
                        ...
                        new FluidBuilder()
                                .temperature((GTValues.VA[GTValues.ZPM] + GTValues.VA[GTValues.UHV]) / 2))
                .color(QuarkGluonPlasma.getMaterialRGB() - HeavyQuarks.getMaterialRGB())
                .buildAndRegister()
                .setFormula(
                        ChatFormatting.OBFUSCATED + "a" + ChatFormatting.RESET + "§e(c2)(t2)b"
                                + ChatFormatting.OBFUSCATED + "a",
                        false);
        ...
        Neutron = Builder("neutron")
                .fluid(
                        FluidStorageKeys.PLASMA, new FluidBuilder().temperature((int) GTValues.V[GTValues.UXV]))
                .color(0xFCFCFC)
                .buildAndRegister()
                .setFormula(
                        ChatFormatting.OBFUSCATED + "a" + ChatFormatting.RESET + "n§e"
                                + ChatFormatting.OBFUSCATED + "a",
                        false);
        ...
        UDMHRocketFuel =
                Builder("udmh_rocket_fuel").fluid().color(0x2AA327).iconSet(DULL).buildAndRegister();

        UDMH = Builder("udmh").fluid().color(0x050543).iconSet(DULL).buildAndRegister();
        ...
        YttriumVanadateLuTmDeposition = Builder("yttrium_vanadate_lu_tm_deposition")
                .dust()
                .color(Yttrium.getMaterialRGB()
                        + Vanadium.getMaterialRGB()
                        + Lutetium.getMaterialRGB()
                        + Thulium.getMaterialRGB())
                .iconSet(DULL)
                .buildAndRegister()
        ...
        HeavyQuarkEnrichedMixture = Builder("heavy_quark_enriched_mixture")
                ...
                .buildAndRegister()
                .setFormula(
                        ChatFormatting.OBFUSCATED + "a" + ChatFormatting.RESET + "§e(u2)d(c2)s(t2)b"
                                + ChatFormatting.OBFUSCATED + "a",
                        true);
        ...
        DeuteriumSuperHeavyMixture = Builder("deuterium_superheavy_mixture")
                ...
                .color(0x7B9F8E)
                .components(
                        Deuterium, 2, MetastableHassium, 1, MetastableFlerovium, 1, MetastableOganesson, 1)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        TlTmDropedCaesiumIodide = Builder("tl_tm_droped_caesium_iodide")
                .dust()
                .color(
                        Thallium.getMaterialRGB() + Thulium.getMaterialRGB() + CaesiumIodide.getMaterialRGB())
                .iconSet(BRIGHT)
