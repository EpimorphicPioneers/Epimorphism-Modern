...
import com.epimorphismmc.epimorphism.common.machine.multiblock.generator.LargeNaquadahReactorMachine;
import com.epimorphismmc.epimorphism.common.machine.multiblock.generator.MegaTurbineMachine;
import com.epimorphismmc.epimorphism.common.machine.multiblock.generator.RocketEngineMachine;
import com.epimorphismmc.epimorphism.common.machine.multiblock.generator.SolidOxideFuelCellMachine;
import com.epimorphismmc.epimorphism.common.machine.multiblock.generator.UniversalChemicalFuelEngineMachine;
...
import static com.epimorphismmc.epimorphism.common.data.EPBlocks.CASING_SUPERCRITICAL_FLUID_GEARBOX;
import static com.epimorphismmc.epimorphism.common.data.EPBlocks.CASING_SUPERCRITICAL_FLUID_TURBINE;
import static com.epimorphismmc.epimorphism.common.data.EPBlocks.CASING_TURBO_ENGINE_GEARBOX;
import static com.epimorphismmc.epimorphism.common.data.EPBlocks.TITANIUM_PLATED_CYLINDER;
import static com.epimorphismmc.epimorphism.common.data.EPBlocks.TURBO_ENGINE_CASING;
import static com.epimorphismmc.epimorphism.common.data.EPRecipeTypes.HIGH_PRESSURE_STEAM_TURBINE_FUELS;
...
import static com.epimorphismmc.epimorphism.common.data.EPRecipeTypes.LARGE_NAQUADAH_REACTOR_FUELS;
import static com.epimorphismmc.epimorphism.common.data.EPRecipeTypes.ROCKET_ENGINE_FUELS;
import static com.epimorphismmc.epimorphism.common.data.EPRecipeTypes.SUPERCRITICAL_STEAM_TURBINE_FUELS;
...
import static com.gregtechceu.gtceu.api.machine.multiblock.PartAbility.IMPORT_ITEMS;
...
import static com.gregtechceu.gtceu.api.machine.multiblock.PartAbility.OUTPUT_ENERGY;
import static com.gregtechceu.gtceu.api.pattern.Predicates.abilities;
import static com.gregtechceu.gtceu.api.pattern.Predicates.air;
import static com.gregtechceu.gtceu.api.pattern.Predicates.autoAbilities;
import static com.gregtechceu.gtceu.api.pattern.Predicates.blocks;
import static com.gregtechceu.gtceu.api.pattern.Predicates.controller;
import static com.gregtechceu.gtceu.common.data.GTBlocks.CASING_ENGINE_INTAKE;
...
import static com.gregtechceu.gtceu.common.data.GTBlocks.CASING_TITANIUM_TURBINE;
import static com.gregtechceu.gtceu.common.data.GTBlocks.CASING_TUNGSTENSTEEL_GEARBOX;
import static com.gregtechceu.gtceu.common.data.GTBlocks.CASING_TUNGSTENSTEEL_TURBINE;
...
public class GeneratorMachines {
    ...
    public static final MultiblockMachineDefinition LARGE_NAQUADAH_REACTOR = registrate()
            .multiblock("large_naquadah_reactor", LargeNaquadahReactorMachine::new)
            .langValue("Large Naquadah Reactor")
            .rotationState(RotationState.NON_Y_AXIS)
            .recipeTypes(
                    LARGE_NAQUADAH_REACTOR_FUELS,
                    LARGE_NAQUADAH_COOLANT_LIST,
                    LARGE_NAQUADAH_EXCITED_FLUID_LIST)
            .appearanceBlock(EPBlocks.RADIATION_PROOF_MACHINE_CASING)
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle(
                            "AAAAAAA", "VBBBBBV", "VVVVVVV", "B#####B", "B#####B", "B#####B", "B#####B",
                            "VVVVVVV")
                    .aisle(
                            "AAAAAAA", "B#####B", "V#####V", "#######", "#######", "#######", "#######",
                            "VVVVVVV")
                    .aisle(
                            "AAAAAAA", "B#CCC#B", "V#CCC#V", "##CCC##", "##CCC##", "##CCC##", "##CCC##",
                            "VVVVVVV")
                    .aisle(
                            "AAAAAAA", "B#CCC#B", "V#CDC#V", "##CDC##", "##CDC##", "##CDC##", "##CDC##",
                            "VVVVVVV")
                    .aisle(
                            "AAAAAAA", "B#CCC#B", "V#CCC#V", "##CCC##", "##CCC##", "##CCC##", "##CCC##",
                            "VVVVVVV")
                    .aisle(
                            ...
                            "VVVVVVV")
                    .aisle(
                            "AAASAAA", "VBBBBBV", "VVVVVVV", "B#####B", "B#####B", "B#####B", "B#####B",
                            "VVVVVVV")
                    .where("S", controller(blocks(definition.get())))
                    .where("V", blocks(EPBlocks.RADIATION_PROOF_MACHINE_CASING.get()))
                    .where(
                            "A",
                            blocks(EPBlocks.RADIATION_PROOF_MACHINE_CASING.get())
                    ...
                    .where(
                            "B",
                            blocks(ChemicalHelper.getBlock(TagPrefix.frameGt, EPMaterials.RadiationProtection)))
            ...
            .workableCasingRenderer(
                    ...
                    Epimorphism.id("block/multiblock/generator/large_naquadah_reactor"),
                    false)
            .register();
    public static final MultiblockMachineDefinition UNIVERSAL_CHEMICAL_FUEL_ENGINE = registrate()
            .multiblock("universal_chemical_fuel_engine", UniversalChemicalFuelEngineMachine::new)
            ...
            .workableCasingRenderer(
                    ...
                    Epimorphism.id("block/multiblock/generator/universal_chemical_fuel_engine"),
                    false)
            .register();
    public static final MultiblockMachineDefinition ROCKET_ENGINE_F1A = registrate()
            .multiblock("rocket_engine_f1a", RocketEngineMachine::new)
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where(
                            "B",
                            blocks(TURBO_ENGINE_CASING.get())
                    ...
                    .build())
            .workableCasingRenderer(
                    Epimorphism.id("block/casings/solid/turbo_engine_casing"),
                    Epimorphism.id("block/multiblock/generator/rocket_engine_f1a"),
                    false)
            .register();
    public static final MultiblockMachineDefinition[] SOLID_OXIDE_FUEL_CELL =
            EPMachines.registerTieredEPMultis(
                    ...
                    (tier, builder) -> builder
                            ...
                            .pattern((definition) -> FactoryBlockPattern.start()
                                    ...
                                    .where(
                                            'A',
                                            blocks(SolidOxideFuelCellMachine.getCasingState(tier))
                    ...
                    HV,
                    IV);
    public static final MultiblockMachineDefinition HIGH_PRESSURE_STEAM_TURBINE =
            registerEPLargeTurbine(
                    "high_pressure_steam_turbine",
                    EV,
                    HIGH_PRESSURE_STEAM_TURBINE_FUELS,
                    CASING_TITANIUM_TURBINE,
                    CASING_TITANIUM_GEARBOX,
                    GTCEu.id("block/casings/solid/machine_casing_stable_titanium"),
                    Epimorphism.id("block/multiblock/generator/high_pressure_steam_turbine"));
    public static final MultiblockMachineDefinition SUPERCRITICAL_STEAM_TURBINE =
            registerEPLargeTurbine(
                    "supercritical_steam_turbine",
                    LuV,
                    SUPERCRITICAL_STEAM_TURBINE_FUELS,
                    CASING_SUPERCRITICAL_FLUID_TURBINE,
                    CASING_SUPERCRITICAL_FLUID_GEARBOX,
    ...
    public static final MultiblockMachineDefinition STEAM_MEGA_TURBINE = registerMegaTurbine(
            "steam_mega_turbine",
            IV,
            STEAM_TURBINE_FUELS,
            CASING_STEEL_TURBINE,
            CASING_STEEL_GEARBOX,
            GTCEu.id("block/casings/solid/machine_casing_solid_steel"),
            GTCEu.id("block/multiblock/generator/large_steam_turbine"));
    public static final MultiblockMachineDefinition GAS_MEGA_TURBINE = registerMegaTurbine(
            "gas_mega_turbine",
            LuV,
            GAS_TURBINE_FUELS,
            CASING_STAINLESS_CLEAN,
            CASING_STAINLESS_STEEL_GEARBOX,
            GTCEu.id("block/casings/solid/machine_casing_clean_stainless_steel"),
            GTCEu.id("block/multiblock/generator/large_gas_turbine"));
    public static final MultiblockMachineDefinition PLASMA_MEGA_TURBINE = registerMegaTurbine(
            "plasma_mega_turbine",
            ZPM,
            PLASMA_GENERATOR_FUELS,
            CASING_TUNGSTENSTEEL_TURBINE,
            CASING_TUNGSTENSTEEL_GEARBOX,
            GTCEu.id("block/casings/solid/machine_casing_robust_tungstensteel"),
            GTCEu.id("block/multiblock/generator/large_plasma_turbine"));
    public static final MultiblockMachineDefinition HIGH_PRESSURE_STEAM_MEGA_TURBINE =
            registerMegaTurbine(
                    "high_pressure_steam_mega_turbine",
                    LuV,
                    HIGH_PRESSURE_STEAM_TURBINE_FUELS,
                    CASING_TITANIUM_TURBINE,
                    CASING_TITANIUM_GEARBOX,
                    GTCEu.id("block/casings/solid/machine_casing_stable_titanium"),
                    Epimorphism.id("block/multiblock/generator/high_pressure_steam_turbine"));
    public static final MultiblockMachineDefinition SUPERCRITICAL_STEAM_MEGA_TURBINE =
            registerMegaTurbine(
                    "supercritical_steam_mega_turbine",
                    UV,
                    SUPERCRITICAL_STEAM_TURBINE_FUELS,
                    CASING_SUPERCRITICAL_FLUID_TURBINE,
                    CASING_SUPERCRITICAL_FLUID_GEARBOX,
    ...
    public static MultiblockMachineDefinition registerEPLargeTurbine(
            String name,
            int tier,
        ...
        return registrate()
                .multiblock(name, holder -> new LargeTurbineMachine(holder, tier))
                .rotationState(RotationState.NON_Y_AXIS)
                ...
                .pattern(definition -> FactoryBlockPattern.start()
                        ...
                        .where(
                                'R',
                                new TraceabilityPredicate(new SimplePredicate(
                                                state -> MetaMachine.getMachine(state.getWorld(), state.getPos())
                                                                instanceof IRotorHolderMachine rotorHolder
                                                        && state
                                                                .getWorld()
                                                                .getBlockState(
                                                                        state.getPos().relative(rotorHolder.self().getFrontFacing()))
                                                                .isAir(),
                                        ...
                                        .addTooltips(Component.translatable(
                                                "gtceu.multiblock.pattern.error.limited.1", VN[tier]))
                                        .setExactLimit(1)
    ...
    public static MultiblockMachineDefinition registerMegaTurbine(
            String name,
            int tier,
            GTRecipeType recipeType,
            Supplier<? extends Block> casing,
            ...
            ResourceLocation overlayModel) {
        return registrate()
                .multiblock(name, holder -> new MegaTurbineMachine(holder, tier))
                .rotationState(RotationState.NON_Y_AXIS)
                .recipeType(recipeType)
                .appearanceBlock(casing)
                .pattern(definition -> FactoryBlockPattern.start()
