...
//                .buildAndRegister();
//
//        //  Niobium Pentachloride + Lithium Hydride -> Lithium Niobate + Sulfuric Acid (chlorine
// cycle, 5HCl -> Cl5 -> NbCl5)
...
//                .buildAndRegister();
//
//        //  High Purity Sodium Vanadate + Carbamide + Lu-Tm-Y Chlorides Solution -> Lu-Tm-droped
// Yttrium Vanadate Deposition + Chlorine
//        CHEMICAL_RECIPES.recipeBuilder()
...
//                .buildAndRegister();
//
//        //  Lu-Tm-droped Yttrium Vanadate deposition + Ethanol -> Lu/Tm:YVO + Ammonium Carbonate +
// Propene
