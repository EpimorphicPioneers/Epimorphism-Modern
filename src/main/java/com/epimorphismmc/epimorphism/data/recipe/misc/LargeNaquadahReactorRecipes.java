...
public class LargeNaquadahReactorRecipes {

    public static void init(Consumer<FinishedRecipe> provider) {
        coolant(provider);
        excitedFluid(provider);

        EPRecipeTypes.LARGE_NAQUADAH_REACTOR_FUELS
                ...
                .EUt(-2200)
                .duration(EPRecipeUtil.second(25))
                .save(provider);
        EPRecipeTypes.LARGE_NAQUADAH_REACTOR_FUELS
                .recipeBuilder("uranium_based_liquid_fuel_depleted")
                ...
                .save(provider);
        EPRecipeTypes.LARGE_NAQUADAH_REACTOR_FUELS
                .recipeBuilder("plutonium_based_liquid_fuel_depleted")
                ...
                .EUt(-32400)
                .duration(EPRecipeUtil.second(7.5))
                .save(provider);
    }
    ...
    private static void registerCoolant(
            Material material, int efficiency, int consumption_rate, Consumer<FinishedRecipe> provider) {
        EPRecipeTypes.LARGE_NAQUADAH_COOLANT_LIST
                .recipeBuilder(
                        "large_naquadah_coolant.%s".formatted(material.getName().toLowerCase(Locale.ROOT)))
    ...
    private static void registerExcitedFluid(
            Material material, int parallel, int consumption_rate, Consumer<FinishedRecipe> provider) {
        EPRecipeTypes.LARGE_NAQUADAH_EXCITED_FLUID_LIST
                .recipeBuilder("large_naquadah_excited_fluid.%s"
