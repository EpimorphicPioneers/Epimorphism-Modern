...
public class MachineLang {
    public static void init(MOLangProvider provider) {
        ...
        provider.addBlockWithTooltip(
                GeneratorMachines.LARGE_NAQUADAH_REACTOR::getBlock, "大型硅岩反应堆", List.of(), List.of());
        provider.add(
                "block.epimorphism.large_naquadah_reactor.real_eut",
                "Energy output: %s EU/t",
                "能量输出：%s EU/t");

        provider.addBlockWithTooltip(
                GeneratorMachines.UNIVERSAL_CHEMICAL_FUEL_ENGINE::getBlock,
                "通用化学能引擎",
                List.of(),
                List.of());
        provider.add(
        ...
        provider.addBlockWithTooltip(CATALYTIC_REFORMER::getBlock, "催化重整炉", List.of(), List.of());

        provider.addBlockWithTooltip(CRYOGENIC_REACTOR::getBlock, "低温反应室", List.of(), List.of());
        ...
        provider.addBlockWithTooltip(
                AdvancedMachines.CIRCUIT_ASSEMBLY_LINE::getBlock, "电路装配线", List.of(), List.of());

        provider.addMultiLang(
                "gui.epimorphism.circuit_assembly_line.template.desc",
                List.of("Template Inventory", "Used to identify the current circuit assembly line recipe."),
                List.of("样板仓库", "用来识别当前的电路装配线配方"));
        ...
        provider.addBlockWithTooltip(ISA_MILL::getBlock, "艾萨研磨机", List.of(), List.of());

        provider.addBlockWithTooltip(INTEGRATED_ORE_FACTORY::getBlock, "集成矿石处理厂", List.of(), List.of());

        provider.addMultiLang(
                "block.epimorphism.integrated_ore_factory.ore_processing_mode.%s"::formatted,
                tier -> "Processing Mode %s".formatted(tier + 1),
                tier -> "处理模式 %s".formatted(tier + 1),
                tiersBetween(0, 4));
        ...
        provider.addBlockWithTooltip(
                INDUSTRIAL_FLOTATION_CELL::getBlock, "工业级浮选机", List.of(), List.of());

        provider.addBlockWithTooltip(
                AdvancedMachines.PRECISE_ASSEMBLER::getBlock,
                "精密组装机",
                List.of(
        ...
        provider.addBlockWithTooltip(INDUSTRIAL_DRILL::getBlock, "工业钻机", List.of(), List.of());
        ...
        provider.addBlockWithTooltip(PLASMA_CVD::getBlock, "等离子体增强化学气相沉积单元", List.of(), List.of());

        provider.addBlockWithTooltip(LASER_CVD::getBlock, "激光诱导化学气相沉积单元", List.of(), List.of());

        provider.addBlockWithTooltip(NANOSCALE_FABRICATOR::getBlock, "纳米制造室", List.of(), List.of());

        provider.addBlockWithTooltip(CRYSTALLIZATION_CRUCIBLE::getBlock, "结晶坩埚", List.of(), List.of());
        ...
        provider.add(
                "gtceu.multiblock.fusion_reactor.uhv.description",
        ...
        provider.add(
                "gtceu.multiblock.fusion_reactor.uev.description",
