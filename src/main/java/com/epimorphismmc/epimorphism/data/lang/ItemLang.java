...
public class ItemLang {
    public static void init(MOLangProvider provider) {
        ...
        provider.addItemWithTooltip(
                ...
                "§7超高效光电子载运");
        provider.addItemWithTooltip(
                OPTICAL_ASSEMBLY, "Optical IMC Assembly", "光学存算一体处理器集群", "§7Photon Surge", "§7光子涌流");
        provider.addItemWithTooltip(
                OPTICAL_COMPUTER,
        ...
        //  Components
        provider.addItemWithTooltip(
                OPTICAL_TRANSISTOR, "Phototransistor", "光学晶体管", "§Optical Transistor", "§7光电子晶体管");
        provider.addItemWithTooltip(
                OPTICAL_RESISTOR, "Photoresistor", "光敏电阻", "§7Optical Resistor", "§7光电子电阻");
        provider.addItemWithTooltip(
                OPTICAL_CAPACITOR, "Optical Integrator", "光学整合器", "§7Optical Capacitor", "§7光电子电容");
        provider.addItemWithTooltip(
                OPTICAL_DIODE, "Optical Isolator", "光频隔离器", "§7Optical Diode", "§7光电子二极管");
        provider.addItemWithTooltip(
                OPTICAL_INDUCTOR, "Optical Polarizer", "光学偏振器", "§7Optical Inductor", "§7光电子电感");

        provider.addItemWithTooltip(
                SPINTRONIC_TRANSISTOR, "MOSFET", "自旋金属-氧半场效晶体管", "§7Spintronic Transistor", "§7自旋电子晶体管");
        provider.addItemWithTooltip(
                SPINTRONIC_RESISTOR, "Magnetoresistor", "磁阻器", "§7Spintronic Resistor", "§7自旋电子电阻");
        provider.addItemWithTooltip(
                SPINTRONIC_CAPACITOR, "Ultracapacitor", "超级电容", "§7Spintronic Capacitor", "§7自旋电子电容");
        provider.addItemWithTooltip(
                SPINTRONIC_DIODE, "Schottky Diode", "肖氏势垒二极管", "§7Spintronic Diode", "§7自旋电子二极管");
        provider.addItemWithTooltip(
                SPINTRONIC_INDUCTOR, "Spin Polarizer", "自旋偏振器", "§7Spintronic Inductor", "§7自旋电子电感");
        ...
        provider.addItemWithTooltip(
                ...
                "§7寰宇电阻");
        provider.addItemWithTooltip(
                COSMIC_CAPACITOR, "Holographic Energy Charge", "全息能量荷", "§7Cosmic Capacitor", "§7寰宇电容");
        provider.addItemWithTooltip(
                COSMIC_DIODE, "Cosmic Ion Diode", "宇宙离子极管", "§7Cosmic Diode", "§7寰宇二极管");
        provider.addItemWithTooltip(
                COSMIC_INDUCTOR, "Zenith Polarizer", "天顶星偏振器", "§7Cosmic Inductor", "§7寰宇电感");

        provider.addItemWithTooltip(
                SUPRACAUSAL_TRANSISTOR,
                "Kaluza-Klein Extradimensional Dilator Field Effect Transistor",
                "卡鲁扎-克莱因额外维胀子场效应管",
                "§7Supracausal Transistor",
                "§7超因果晶体管");
        provider.addItemWithTooltip(
                SUPRACAUSAL_RESISTOR,
                "Non anomalous Quantum Main Constraint Generator",
                "非反常量子主约束生成器",
                "§7Supracausal Resistor",
                "§7超因果电阻");
        provider.addItemWithTooltip(
                SUPRACAUSAL_CAPACITOR,
        ...
        //  SoC
        provider.addItemWithTooltip(
                INTRAVITAL_SOC, "Intravital SoC", "活体SoC", "§7A wriggling Circuits", "§7蠕动着的电路");
        provider.addItemWithTooltip(
                PHOTOELECTRON_SOC, "Photoelectric SoC", "光电子SoC", "§7Luminous Circuits", "§7荧光电路");
        ...
        provider.addItemName(
                MANIFOLD_OSCILLATORY_POWER_CELL, "Manifold Oscillatory Power Cell", "流形震荡能量单元");
        ...
        //  Wafers
        provider.addItemWithTooltip(
                NANO_PIC_WAFER, "NPIC Wafer", "NPIC晶圆", "§7Raw Nano Power Circuit", "§7纳米功率集成电路原料");
        provider.addItemWithTooltip(
                NANO_PIC_CHIP, "NPIC", "NPIC芯片", "§7Nano Power Integrated Circuit", "§7纳米功率集成电路");
        provider.addItemWithTooltip(
                PICO_PIC_WAFER, "PPIC Wafer", "PPIC晶圆", "§7Raw Pico Power Circuit", "§7皮米功率集成电路原料");
        provider.addItemWithTooltip(
                PICO_PIC_CHIP, "PPIC", "PPIC芯片", "§7Pico Power Integrated Circuit", "§7皮米功率集成电路");
        provider.addItemWithTooltip(
                DUBNIUM_BOULE,
        ...
        provider.addItemWithTooltip(
                ...
                "§7放入艾萨研磨机以处理矿物");
        provider.add(
                "item.epimorphism.grind_ball.desc.yield_multiplier", "Yield Multiplier: %s", "产量系数：%s");
        provider.add(
        ...
        provider.add(
                "item.epimorphism.debug.structure_writer.export_to_file", "Export as a file", "导出为文件");
        provider.add(
                "item.epimorphism.debug.structure_writer.rotate_along_x_axis",
                "Rotate along the X axis",
                "沿X轴旋转");
        provider.add(
                "item.epimorphism.debug.structure_writer.rotate_along_y_axis",
        ...
        //  Coil
        provider.addItemWithTooltip(
                VOLTAGE_COIL_UHV, "Ultra High Voltage Coil", "极高压线圈", "Ultra Coil", "极致线圈");
        provider.addItemWithTooltip(
                VOLTAGE_COIL_UEV, "Ultra Excessive Voltage Coil", "极超压线圈", "Unreal Coil", "超凡线圈");
        provider.addItemWithTooltip(
                VOLTAGE_COIL_UIV, "Ultra Immense Voltage Coil", "极巨压线圈", "Insane Coil", "疯狂线圈");
        provider.addItemWithTooltip(
                VOLTAGE_COIL_UXV, "Ultra Extreme Voltage Coil", "极顶压线圈", "Epic Coil", "史诗线圈");
        provider.addItemWithTooltip(
                VOLTAGE_COIL_OPV, "Overpowered Voltage Coil", "过载压线圈", "Legendary Coil", "传奇线圈");

        //  Covers
        provider.addItemName(ELECTRIC_PUMP_MAX, "§c§lMAX§r Electric Pump", "§c§lMAX§r电动泵");
        provider.addItemName(FLUID_REGULATOR_MAX, "§c§lMAX§r Fluid Regulator", "§c§lMAX§r流体校准器");
        provider.addItemName(CONVEYOR_MODULE_MAX, "§c§lMAX§r Conveyor Module", "§c§lMAX§r传送带");
        provider.addItemName(ROBOT_ARM_MAX, "§c§lMAX§r Robot Arm", "§c§lMAX§r机械臂");
        provider.addItemName(ELECTRIC_MOTOR_MAX, "§c§lMAX§r Electric Motor", "§c§lMAX§r电动马达");
        provider.addItemName(ELECTRIC_PISTON_MAX, "§c§lMAX§r Electric Piston", "§c§lMAX§r电力活塞");
        provider.addItemName(EMITTER_MAX, "§c§lMAX§r Emitter", "§c§lMAX§r发射器");
        provider.addItemName(SENSOR_MAX, "§c§lMAX§r Sensor", "§c§lMAX§r传感器");
        provider.addItemName(FIELD_GENERATOR_MAX, "§c§lMAX§r Field Generator", "§c§lMAX§r力场发生器");

        //  Lasers
        provider.addItemWithTooltip(
                OPTICAL_FIBER, "Optical Fiber", "光纤", "§7Light-transmitting Glass", "§7透光玻璃");
        provider.addItemWithTooltip(
                DIELECTRIC_MIRROR, "Dielectric Mirror", "介电镜", "§7Bragg Mirror", "§7布氏镜");
        provider.addItemWithTooltip(
                EMPTY_GAS_LASER_EMITTER,
        ...
        //  Halide Lamps
        provider.addItemName(GREEN_LAMP_CORE, "Green Halide Lamp Core", "绿光卤素灯核心");
        provider.addItemName(GREEN_HALIDE_LAMP, "Green Halide Lamp", "绿光卤素灯");
        provider.addItemName(RED_LAMP_CORE, "Red Halide Lamp Core", "红光卤素灯核心");
        provider.addItemName(RED_HALIDE_LAMP, "Red Halide Lamp", "红光卤素灯");
        provider.addItemName(BLUE_LAMP_CORE, "Blue Halide Lamp Core", "蓝光卤素灯核心");
        provider.addItemName(BLUE_HALIDE_LAMP, "Blue Halide Lamp", "蓝光卤素灯");
        provider.addItemName(WHITE_LAMP_CORE, "White Halide Lamp Core", "白光卤素灯核心");
        provider.addItemName(WHITE_HALIDE_LAMP, "White Halide Lamp Core", "白光卤素灯");
        provider.addItemName(UVA_LAMP_CORE, "UVA Laser Emitter", "UVA卤素灯核心");

        provider.addItemName(ROTATING_TRANSPARENT_SURFACE, "Rotating Transparent Surface", "旋转透明层");
        provider.addItemWithTooltip(
                PERIODICALLY_POLED_LITHIUM_NIOBATE_BOULE,
                "Periodically Poled Lithium Niobate Boule",
                "周期性极化铌酸锂晶体",
                "§7Optical Superlattice Crystal",
                "§7光学超晶格晶体");
        provider.addItemWithTooltip(
                NON_LINEAR_OPTICAL_LENS,
        ...
        provider.addItemWithTooltip(
                BOSE_EINSTEIN_CONDENSATE_CONTAINMENT_UNIT,
        ...
        provider.addItemName(
                PROTONATED_FULLERENE_SIEVING_MATRIX, "Protonated Fullerene Sieving Matrix", "质子化富勒烯筛分基质");
        provider.addItemName(
                SATURATED_FULLERENE_SIEVING_MATRIX, "Saturated Fullerene Sieving Matrix", "饱和富勒烯筛分基质");
        provider.addItemName(
                METASTABLE_SELF_HEALING_ADHESIVE, "Metastable Self-healing Adhesive", "超稳态自修复粘合剂");
        provider.addItemName(
                HYPERDIMENSIONAL_TACHYON_CONDENSED_MATTER,
...
*/
        ...
        //  Algae
        provider.addItemName(ORDINARY_ALGAE, "Ordinary Algae", "普通藻类");
        provider.addItemName(RED_ALGA, "Red Alga", "红藻");
        provider.addItemName(GREEN_ALGA, "Green Alga", "绿藻");
        provider.addItemName(CHRYSOPHYCEAE, "Golden Alga", "金藻");
        provider.addItemName(BROWN_ALGA, "Brown Alga", "褐藻");
        provider.addItemName(PINECONE, "Pinecone", "松果");
        ...
        // Bacterium
        provider.addItemWithTooltip(
                STERILIZED_PETRI_DISH, "Sterilized Petri Dish", "无菌培养皿", "§7", "§7");
