...
public class ParallelGlassCoilMultiblockMachine extends MultiStatsElectricMultiblockMachine
        implements IParallelMachine, IGlassMachine, ICoilMachine {
    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            ParallelGlassCoilMultiblockMachine.class,
    ...
    public ParallelGlassCoilMultiblockMachine(
            IMachineBlockEntity holder,
            Function<ParallelGlassCoilMultiblockMachine, Integer> parallelCalculator,
            Object... args) {
        super(holder, parallelCalculator, args);
        this.parallelStats = new ParallelStats(this, machine -> {
            if (machine
                    instanceof ParallelGlassCoilMultiblockMachine parallelGlassCoilMultiblockMachine) {
