...
public class ParallelCoilCasingMultiblockMachine extends MultiStatsElectricMultiblockMachine
        implements IParallelMachine, ICoilMachine, ICasingMachine {
    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            ParallelCoilCasingMultiblockMachine.class,
    ...
    public ParallelCoilCasingMultiblockMachine(
            IMachineBlockEntity holder,
            String typeName,
            Function<ParallelCoilCasingMultiblockMachine, Integer> parallelCalculator,
            Object... args) {
        super(holder, parallelCalculator, args);
        this.parallelStats = new IParallelMachine.ParallelStats(this, machine -> {
            if (machine
                    instanceof ParallelCoilCasingMultiblockMachine parallelCoilCasingMultiblockMachine) {
