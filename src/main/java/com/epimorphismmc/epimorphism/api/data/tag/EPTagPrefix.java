...
public class EPTagPrefix {
    public static final TagPrefix singularity = new MOTagPrefix(
                    ...
                    new HaloItemBehavior(
                            4, 0xFF000000, new ResourceLocation(Epimorphism.MOD_ID, "sprite/halo"), true, false))
    ...
    public static final TagPrefix seedCrystal = new TagPrefix("seedCrystal")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .generationCondition(hasGemProperty.and(mat -> mat.hasFlag(GENERATE_BOULE)
                    || (mat.hasFlag(CRYSTALLIZABLE) && !mat.hasFlag(DISABLE_CRYSTALLIZATION))));
    ...
    public static final TagPrefix nanites = new TagPrefix("nanites")
            ...
            .generateItem(true)
            .generationCondition(
                    hasDustProperty.and(mat -> mat.hasFlag(GENERATE_NANITES) && !mat.hasFlag(NO_SMASHING)));
    ...
    public static final TagPrefix catalyst = new TagPrefix("catalyst")
            ...
            .itemTable(() -> EPChemistryItem.CATALYST_ITEMS)
            .materialAmount(-1)
    ...
    public static final TagPrefix fence = new TagPrefix("fence")
            ...
            .blockProperties(
                    () -> RenderType::cutout, p -> p.forceSolidOn().instrument(NoteBlockInstrument.BASS))
            .unificationEnabled(true);
