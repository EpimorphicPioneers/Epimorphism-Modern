package com.epimorphismmc.epimorphism.client.particle;
...
public class CropParticleData implements ParticleOptions {
    ...
    public static final Deserializer<CropParticleData> DESERIALIZER = new Deserializer<>() {
        @Override
        public CropParticleData fromCommand(
                ParticleType<CropParticleData> particleTypeIn, StringReader reader)
        ...
        @Override
        public CropParticleData fromNetwork(
                ParticleType<CropParticleData> particleTypeIn, FriendlyByteBuf buffer) {
