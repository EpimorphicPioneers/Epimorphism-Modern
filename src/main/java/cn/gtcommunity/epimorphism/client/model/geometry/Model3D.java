...
public class Model3D {
    ...
    private final Model3D.SpriteInfo[] textures = new Model3D.SpriteInfo[6];
    ...
    public Model3D prepFlowing(@NotNull FluidStack fluid) {
        Model3D.SpriteInfo still = new Model3D.SpriteInfo(FluidHelper.getStillTexture(fluid), 16);
        Model3D.SpriteInfo flowing = new Model3D.SpriteInfo(EPFluidUtil.getFlowingTexture(fluid), 8);
    ...
    public Model3D setTexture(TextureAtlasSprite tex, int size) {
        Arrays.fill(textures, new Model3D.SpriteInfo(tex, size));
        return this;
    }

    public Model3D setTextures(Model3D.SpriteInfo down, Model3D.SpriteInfo up, Model3D.SpriteInfo north, Model3D.SpriteInfo south, Model3D.SpriteInfo west, Model3D.SpriteInfo east) {
        textures[0] = down;
        textures[1] = up;
        textures[2] = north;
        textures[3] = south;
