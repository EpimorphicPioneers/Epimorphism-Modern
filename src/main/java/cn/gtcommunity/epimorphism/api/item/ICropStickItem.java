...
// */
//public interface ICropStickItem {
//    /**
...
//            if(item instanceof ICropStickItem) {
//                return this.isSameType((ICropStickItem) item);
//            }
//            return false;
//        }
//
...
//         * @return true if the item is of the same type
//         */
//        default boolean isSameType(ICropStickItem item) {
...
//         */
//        @Nullable
//        static Variant create(String name, MapColor mapColor, SoundType sound, Predicate<Fluid> fluidPredicate) {
//            return AgriApi.createCropStickVariant(name, mapColor, sound, fluidPredicate);
//        }
//    }
//}
