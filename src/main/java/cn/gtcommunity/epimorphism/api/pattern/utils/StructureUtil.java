...
public class StructureUtil {
    ...
    public static BlockState getTierController(IMachineBlock controller, int tier, Direction direction) {
        return controller.getRotationState() == RotationState.NONE ?
                controller.self().defaultBlockState().setValue(EPBlockProperties.MULTIBLOCK_TIER, tier) :
                controller.self().defaultBlockState().setValue(controller.getRotationState().property, direction).setValue(EPBlockProperties.MULTIBLOCK_TIER, tier);
    }
