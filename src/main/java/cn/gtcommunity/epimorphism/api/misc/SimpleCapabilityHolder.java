...
public class SimpleCapabilityHolder implements IRecipeCapabilityHolder {
    ...
    public SimpleCapabilityHolder() {
        ...
        this.capabilitiesProxy.put(IO.IN, EURecipeCapability.CAP, List.of(new IRecipeHandler<Long>() {

            @Override
            public List<Long> handleRecipeInner(IO io, GTRecipe gtRecipe, List<Long> list, @Nullable String s, boolean b) {
                return null;
            }
