...
public class LockableSlotWidget extends SlotWidget {
    ...
    public LockableSlotWidget(IItemTransfer itemHandler, int slotIndex, int xPosition, int yPosition, Supplier<Boolean> isLock, Consumer<Boolean> setLock) {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (slotReference != null && isMouseOverElement(mouseX, mouseY) && gui != null) {
            ...
            boolean isShiftClick = InputConstants.isKeyDown(id, GLFW.GLFW_KEY_LEFT_SHIFT) || InputConstants.isKeyDown(id, GLFW.GLFW_KEY_RIGHT_SHIFT);
            if (isShiftClick) {
