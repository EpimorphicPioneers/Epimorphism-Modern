...
public class MachineLang {
        public static void init(LanguageProvider provider) {
                ...
                addBlockWithTooltip(provider, FRACKER::getBlock, "液压压裂机",
                                List.of(
                ...
                addBlockWithTooltip(provider, INFINITE_FLUID_DRILLING_RIG::getBlock, "无限流体钻机",
                                List.of(
                ...
                /*addBlockWithTooltip(provider, CONCRETE_BACKFILLER::getBlock, "混凝土回填机",
                                List.of(
                ...
                addBlockWithTooltip(provider, ::getBlock, "工业级浮选机",
                                List.of(
