...
public class MaterialLang {
    public static void init(MOLangProvider provider) {
        ...
        provider.addMaterial(OverheatedBromineSulfateSolution, "Overheated Bromine Sulfate Solution", "过热硫酸溴溶液");
        ...
        provider.addMaterial(HexafluorideEnrichedNaquadahSolution, "Hexafluoride Enriched Naquadah Solution", "六氟化富集硅岩溶液");
        provider.addMaterial(XenonHexafluoroEnrichedNaquadate, "Xenon Hexafluoro-Enriched Naquadate", "六氟氙酸富集硅岩");
        provider.addMaterial(EnrichedNaquadahResidueSolution, "Enriched Naquadah Residue Solution", "富集硅岩残余物溶液");
        ...
        provider.addMaterial(AcidicNaquadriaCaesiumfluoride, "Acidic Naquadria Caesiumfluoride", "硫酸二氟超能硅岩酸铯");
        provider.addMaterial(NitrosoniumOctafluoroxenate, "Nitrosonium Octafluoroxenate", "八氟氙酸亚硝酰");
        provider.addMaterial(NaquadriaCaesiumXenonnonfluoride, "Naquadria Caesium Xenonnonfluoride", "九氟氙酸超能硅岩酸铯");
        ...
        provider.addMaterial(HexafluorideNaquadriaSolution, "Hexafluoride Naquadria Solution", "六氟化超能硅岩溶液");
        ...
        provider.addMaterial(PraseodymiumDopedZBLANGlass, "Praseodymium doped ZBLAN Glass", "掺镨的ZBLAN玻璃");
        ...
        provider.addMaterial(ChromiumGermaniumTellurideMagnetic, "Magnetic Chromium Germanium Telluride", "磁化碲化锗铬");
        ...
        provider.addMaterial(MagnetoHydrodynamicallyConstrainedStarMatter, "Magneto Hydrodynamically Constrained Star Matter", "磁流体动力学约束恒星等离子体物质");
        ...
        provider.addMaterial(DimensionallyTranscendentResidue, "Dimensionally Transcendent Residue", "超维度残余物");
        ...
        provider.addMaterial(BariumStrontiumRadiumSolution, "Barium-Strontium-Radium Solution", "碱性钡-锶-镭溶液");
        ...
        provider.addMaterial(UraniumOxideThoriumNitrate, "Uranium Oxide Thorium Nitrate", "二氧化铀-硝酸钍混合物");
        ...
        provider.addMaterial(AmmoniumHexachloroPlatinumGroupSludge, "Ammonium Hexachloro Platinum Group Sludge", "六氯铵酸化铂族金属泥浆液");
        ...
        provider.addMaterial(SteamCrackedCalifornium252Hexafluoride, "Steam Cracked Californium-252 Hexafluoride", "蒸汽裂化六氟化锎-252");
        ...
        provider.addMaterial(MethylhydrazineNitrateRocketFuel, "Methylhydrazine Nitrate Rocket Fuel", "硝酸甲肼火箭燃料");
        ...
        provider.addMaterial(LutetiumThuliumYttriumChloridesSolution, "Lutetium Thulium Yttrium Chlorides Solution", "镥铥钇氯化物溶液");
        provider.addMaterial(YttriumVanadateLuTmDeposition, "Yttrium Vanadate Lu-Tm Deposition", "镥铥掺杂的钒酸钇沉淀");
...
//        provider.addMaterial(SodiumPerchlorate, "Sodium Perchlorate", "高氯酸钠");
        ...
        provider.addMaterial(Dichlorocyclooctadieneplatinium, "Dichlorocyclooctadieneplatinium", "（1,5-环辛二烯）二氯化铂");
        provider.addMaterial(Diiodobiphenyl, "Diiodobiphenyl", "二碘代联苯");
        provider.addMaterial(Bipyridine, "Bipyridine", "联吡啶");
        provider.addMaterial(PalladiumBisdibenzylidieneacetone, "Palladium Bisdibenzylidieneacetone", "双（二亚苄基二丙酮）钯");
        ...
        provider.addMaterial(PyromelliticDianhydride, "Pyromellitic Dianhydride (PDMA)", "均苯四酸二酐（PDMA）");
        ...
        provider.addMaterial(BiphenylTetracarboxylicAcidDianhydride, "Biphenyl Tetracarboxylic Acid Dianhydride (BPDA)", "联苯四甲酸二酐（BPDA）");
        provider.addMaterial(Bistrichloromethylbenzene, "1,4-Bis(trichloromethyl)benzene", "1,4-双（三氯甲基）苯");
        ...
        provider.addMaterial(TetrasodiumEDTA, "Ethylenediaminetetraacetic Acid Tetrasodium", "乙二胺四乙酸四钠");
        provider.addMaterial(EthylenediaminetetraaceticAcid, "Ethylenediaminetetraacetic Acid (EDTA)", "乙二胺四乙酸（EDTA）");
        ...
        provider.addMaterial(BETSPerrhenate, "Bisethylenedithiotetraselenafulvalene Perrhenate", "高铼酸双（乙烯二硫代）四硒富瓦烯");
        provider.addMaterial(Bisethylenedithiotetraselenafulvalene, "Bisethylenedithiotetraselenafulvalene (BETS)", "双（乙烯二硫代）四硒富瓦烯（BETS）");
        provider.addMaterial(Lithiumthiinediselenide, "Lithiumthiinediselenide", "二硒醚合硫锂");
        provider.addMaterial(CyclopentadienylTitaniumTrichloride, "Cyclopentadienyl Titanium Trichloride (CTT)", "环戊二烯三氯化钛（CTT）");
        ...
        provider.addMaterial(Hexanitrohexaaxaisowurtzitane, "Hexanitrohexaaxaisowurtzitane", "六硝基六轴异伍兹烷");
        provider.addMaterial(CrudeHexanitrohexaaxaisowurtzitane, "CrudeHexanitrohexaaxaisowurtzitane", "粗制六硝基六轴异伍兹烷");
        provider.addMaterial(Tetraacetyldinitrosohexaazaisowurtzitane, "Tetraacetyldinitrosohexaazaisowurtzitane", "四乙酰二硝基六氮杂异戊二烯");
        provider.addMaterial(Dibenzyltetraacetylhexaazaisowurtzitane, "Dibenzyltetraacetylhexaazaisowurtzitane", "二苄基四乙酰六氮杂异纤锌烷");
        ...
        provider.addMaterial(Hexabenzylhexaazaisowurtzitane, "Hexabenzylhexaazaisowurtzitane", "六苄基六氮杂异伍兹烷");
        ...
        provider.addMaterial(Tetramethylcyclobutanediol, "Tetramethylcyclobutanediol", "2,2,4,4-四甲基-1,3-环丁二醇（CBDO）");
        ...
        provider.addMaterial(PolyPhosphonitrileFluoroRubber, "Poly Phosphonitrile FluoroRubber", "聚膦腈氟橡胶");
        provider.addMaterial(Acrylonitrile, "Acrylonitrile", "丙烯腈");
        provider.addMaterial(PhosphonitrilicChlorideTrimer, "Phosphonitrilic Chloride Trimer", "六氯环三磷腈");
        ...
        provider.addMaterial(ElectrolyteReflectorMixture, "Electrolyte Reflector Mixture", "电介质反射镜形成混合物");
        ...
        provider.addMaterial(FluorinatedEthylenePropylene, "Fluorinated Ethylene Propylene", "聚全氟乙丙烯（FEP）");
        ...
        provider.addMaterial(CleanEnrichedBedrockSolution, "Clean Enriched Bedrock Soot Solution", "洁净富集基岩烟灰溶液");
        ...
        provider.addMaterial(CrackedHeavyEnrichedTaranium, "Radon-Cracked Heavy Enriched Taranium Gas", "氡裂化重富集塔兰金属气");
        provider.addMaterial(CrackedMediumEnrichedTaranium, "Radon-Cracked Medium Enriched Taranium Gas", "氡裂化富集塔兰金属气");
        provider.addMaterial(CrackedLightEnrichedTaranium, "Radon-Cracked Light Enriched Taranium Gas", "氡裂化轻富集塔兰金属气");
        ...
        provider.addMaterial(CrudeRareEarthTurbidSolution, "Crude Rare earth Turbid Solution", "粗制稀土浊溶液");
        provider.addMaterial(NitratedRareEarthTurbidSolution, "Nitrated Rare earth Turbid Solution", "硝化稀土浊溶液");
        ...
        provider.addMaterial(LowPurityRareEarthChloridesSolution, "Low purity Rare earth Chlorides Solution", "低纯度稀土氯化物溶液");
        provider.addMaterial(RoughlyPurifiedRareEarthChloridesSolution, "Roughly purified Rare earth Chlorides Solution", "粗提纯稀土氯化物溶液");
        provider.addMaterial(HighPurityRareEarthChloridesSlurry, "High purity Rare earth Chlorides Slurry", "高纯度稀土氯化物泥浆");
        provider.addMaterial(HighPurityRareEarthChloridesSolution, "High purity Rare earth Chlorides Solution", "高纯度稀土氯化物溶液");
        provider.addMaterial(LowPurityRareEarthChloridesSlag, "Low purity Rare earth Chlorides Slag", "低纯度稀土氯化物残渣");
        ...
        provider.addMaterial(ActiniumRadiumHydroxideSolution, "Actinium Radium Hydroxide Solution", "氢氧化锕镭溶液");
        provider.addMaterial(ActiniumRadiumNitrateSolution, "Actinium Radium Nitrate Solution", "硝酸锕镭溶液");
        provider.addMaterial(HeavyFluorinatedDraconiumSolution, "Heavy Fluorinated Draconium Solution", "重氟龙素溶液");
        ...
        provider.addMaterial(ConcentrateEnrichedNaquadahMixture, "Concentrate Enriched Naquadah Mixture", "浓缩富集硅岩混合物");
        provider.addMaterial(ImpureNaquadahMixtureSolution, "Impure Naquadah Mixture Solution", "含杂硅岩混合物溶液");
        provider.addMaterial(PureNaquadriaMixtureSolution, "Pure Naquadria Mixture Solution", "洁净超能硅岩混合物乳液");
        ...
        provider.addMaterial(AusteniticStainlessSteel904L, "Austenitic Stainless Steel-904L", "超级奥氏体不锈钢-904L");
