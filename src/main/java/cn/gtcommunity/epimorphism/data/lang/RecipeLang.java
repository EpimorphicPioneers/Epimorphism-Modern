...
public class RecipeLang {
    public static void init(MOLangProvider provider) {
        ...
        //  Recipe Data
        provider.add("epimorphism.recipe.mass",
                "Mass: %s kg",
                "质量：%s kg");
        provider.add("epimorphism.recipe.radioactivity",
                "Radiation Dose: %s Sv",
                "辐射剂量：%s Sv");
        ...
        provider.add("epimorphism.recipe.parallel",
                "Parallel: %s",
                "并行：× %s");
        provider.add("epimorphism.recipe.efficiency",
                "Efficiency: %s%",
                "效率：%s%%");

        //  Recipe Condition
        provider.add("recipe.condition.neutron_kinetic_energy.desc",
                "Minimum neutron kinetic energy: %seV\nMaximum neutron kinetic energy: %seV",
                "最小中子动能: %seV\n最大中子动能: %seV");
        provider.addMultiLang("recipe.condition.chemical_plant_casing.desc.%s"::formatted,
        ...
        provider.add("recipe.condition.tier_casing.desc",
                "Casing Tier: %s",
                "外壳等级：%s");
        provider.add("recipe.condition.precise_assembler_casing.desc",
                "Casing Tier: MK-%s",
                "外壳等级：MK-%s");
        provider.add("recipe.condition.heat_capacity.desc",
                "Temperature: %sK",
                "温度：%sK");
    }
