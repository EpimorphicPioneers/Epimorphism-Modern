...
public class FuelRecipes {
    ...
    private static void semiLiquidFuels(Consumer<FinishedRecipe> provider) {
        // Calorific Value: 4
        SEMILIQUID_GENERATOR_FUELS.recipeBuilder(SeedOil.getName())
        ...
        // Calorific Value: 4
        SEMILIQUID_GENERATOR_FUELS.recipeBuilder(FishOil.getName())
        ...
        // Calorific Value: 16
        SEMILIQUID_GENERATOR_FUELS.recipeBuilder(WoodTar.getName())
        ...
        // Calorific Value: 16
        SEMILIQUID_GENERATOR_FUELS.recipeBuilder(Biomass.getName())
        ...
        // Calorific Value: 32
        SEMILIQUID_GENERATOR_FUELS.recipeBuilder(CoalTar.getName())
        ...
        // Calorific Value: 40
        SEMILIQUID_GENERATOR_FUELS.recipeBuilder(Oil.getName())
        ...
        // Calorific Value: 48
        SEMILIQUID_GENERATOR_FUELS.recipeBuilder(Creosote.getName())
        ...
        // Calorific Value: 60
        SEMILIQUID_GENERATOR_FUELS.recipeBuilder(OilHeavy.getName())
        ...
        // Calorific Value: 80
        SEMILIQUID_GENERATOR_FUELS.recipeBuilder(SulfuricHeavyFuel.getName())
        ...
        // Calorific Value: 328
        SEMILIQUID_GENERATOR_FUELS.recipeBuilder(Glycerol.getName())
        ...
        // Calorific Value: 360
        SEMILIQUID_GENERATOR_FUELS.recipeBuilder(HeavyFuel.getName())
    ...
    private static void rocketFuels(Consumer<FinishedRecipe> provider) {
        ROCKET_ENGINE_FUELS.recipeBuilder(RP1RocketFuel.getName())
                .inputFluids(RP1RocketFuel.getFluid(4))
                .duration(3)
                .EUt(-V[EV])
                .save(provider);
        ROCKET_ENGINE_FUELS.recipeBuilder(DenseHydrazineMixtureFuel.getName())
                .inputFluids(DenseHydrazineMixtureFuel.getFluid(2))
                .duration(3)
                .EUt(-V[EV])
                .save(provider);
        ROCKET_ENGINE_FUELS.recipeBuilder(MethylhydrazineNitrateRocketFuel.getName())
                .inputFluids(MethylhydrazineNitrateRocketFuel.getFluid(1))
                .duration(3)
                .EUt(-V[EV])
                .save(provider);
        ROCKET_ENGINE_FUELS.recipeBuilder(UDMHRocketFuel.getName())
    ...
    private static void acidFuelCellFuels(Consumer<FinishedRecipe> provider) {
        ACIDIC_FUEL_CELL_FUELS.recipeBuilder(SulfuricAcid.getName())
        ...
        ACIDIC_FUEL_CELL_FUELS.recipeBuilder(DilutedSulfuricAcid.getName())
        ...
        ACIDIC_FUEL_CELL_FUELS.recipeBuilder(HydrochloricAcid.getName())
        ...
        ACIDIC_FUEL_CELL_FUELS.recipeBuilder(DilutedHydrochloricAcid.getName())
        ...
        ACIDIC_FUEL_CELL_FUELS.recipeBuilder(NitricAcid.getName())
        ...
        ACIDIC_FUEL_CELL_FUELS.recipeBuilder(HypochlorousAcid.getName())
        ...
        ACIDIC_FUEL_CELL_FUELS.recipeBuilder(PhosphoricAcid.getName())
        ...
        ACIDIC_FUEL_CELL_FUELS.recipeBuilder(HydrofluoricAcid.getName())
    ...
    private static void naquadahReactorFuels(Consumer<FinishedRecipe> provider) {
        NAQUADAH_REACTOR_FUELS.recipeBuilder("naquadah_reactor_I")
                ...
                .EUt(-V[EV])
                .save(provider);
        NAQUADAH_REACTOR_FUELS.recipeBuilder("naquadah_reactor_II")
                ...
                .EUt(-V[IV])
                .save(provider);
        NAQUADAH_REACTOR_FUELS.recipeBuilder("naquadah_reactor_III")
                ...
                .EUt(-V[LuV])
                .save(provider);
        NAQUADAH_REACTOR_FUELS.recipeBuilder("naquadah_reactor_IV")
                .inputItems(TagPrefix.bolt, GTMaterials.Naquadria)
                .outputItems(TagPrefix.bolt, GTMaterials.Naquadah)
                .duration((int) (250_000_000L / V[ZPM]))
                .EUt(-V[ZPM])
                .save(provider);
        NAQUADAH_REACTOR_FUELS.recipeBuilder("naquadah_reactor_V")
