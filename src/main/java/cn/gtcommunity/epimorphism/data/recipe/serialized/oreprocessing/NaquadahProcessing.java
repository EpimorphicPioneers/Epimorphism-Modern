...
public class NaquadahProcessing {
    ...
    //  TODO Some recipe should be deleted (e.g. original naquadah -> solutions large chemical recipes).
    ...
    private static void NaquadahChain(Consumer<FinishedRecipe> provider) {
        ...
        DIGESTER_RECIPES.recipeBuilder("naquadah_oxide_mixture")
        ...
        CHEMICAL_RECIPES.recipeBuilder("low_purity_naquadah_solution")
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("extractive_naquadah_oxide") // todo Chemical Dryer?
        ...
        MIXER_RECIPES.recipeBuilder("naquadah_hydroxides_solution")
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("naquadah_hydroxides_solution_split")
...
//                .addCondition(new NeutronKineticEnergyCondition(325 * K, 800 * K))
    ...
    private static void EnrichedNaquadahChain(Consumer<FinishedRecipe> provider) {
        ...
        //  Au + 3F -> AuF3
        CHEMICAL_RECIPES.recipeBuilder("gold_trifluoride")
        ...
        CHEMICAL_RECIPES.recipeBuilder("xenoauric_fluoroantimonic_acid") // todo Chemical Dryer?
    ...
    private static void NaquadriaChain(Consumer<FinishedRecipe> provider) {
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("pure_naquadah_mixture_solution")
        ...
        //  Rn + 2F -> RnF2
        CHEMICAL_RECIPES.recipeBuilder("radon_difluoride")
        ...
        CHEMICAL_RECIPES.recipeBuilder("naquadria_caesiumfluoride") // todo Cryogenic Reacto?
        ...
        ELECTROLYZER_RECIPES.recipeBuilder("acidic_naquadria_caesiumfluoride_cycle")
        ...
        CHEMICAL_RECIPES.recipeBuilder("acidic_naquadria_solution_cycle") // todo Burner Reactor or Roaster?
    ...
    private static void DiethylhexylPhosphoricAcidChain(Consumer<FinishedRecipe> provider) {
        ...
        MIXER_RECIPES.recipeBuilder("ethylhexanol")
        ...
        CHEMICAL_RECIPES.recipeBuilder("diethylhexyl_phosphoric_acid")
    ...
    private static void NaquadriaResidueSolutionCycle(Consumer<FinishedRecipe> provider) {
        ...
        CHEMICAL_RECIPES.recipeBuilder("naquadria_residue_solution_cycle") // todo Chemical Dryer or Burner Reactor?
        ...
        CHEMICAL_RECIPES.recipeBuilder("naquadria_solution_cycle") // todo Chemical Dryer?
