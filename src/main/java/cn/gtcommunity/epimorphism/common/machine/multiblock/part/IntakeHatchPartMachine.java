...
public class IntakeHatchPartMachine extends TieredIOPartMachine {
    ...
    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(IntakeHatchPartMachine.class, TieredIOPartMachine.MANAGED_FIELD_HOLDER);

    protected static final Map<ResourceLocation, Fluid> AIR_MAP = new HashMap<>();

    @Nullable
    protected TickableSubscription intakeSubs;
    @Nullable
    ...
    protected void intake() {
        ...
        boolean isFilled = tank.fillInternal(FluidStack.create(fluid, getIntakeAmount(getTier())), false) == 0;
