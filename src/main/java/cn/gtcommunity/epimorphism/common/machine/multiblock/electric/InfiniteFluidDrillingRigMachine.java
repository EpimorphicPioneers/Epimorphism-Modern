...
public class InfiniteFluidDrillingRigMachine extends WorkableElectricMultiblockMachine {
    ...
    private class InfiniteFluidDrillLogic extends RecipeLogic {
        ...
        @Override
        public InfiniteFluidDrillingRigMachine getMachine() {
            return (InfiniteFluidDrillingRigMachine) super.getMachine();
        }
        ...
        protected boolean isOverclocked() {
            return getEnergyTier() > getMachine().getTier();
        }

        public int getRigMultiplier() {
            if (isOverclocked()) {
                return (int) (256 + Math.pow(2, getEnergyTier() - getMachine().getTier()));
            }
            return 256;
        }
