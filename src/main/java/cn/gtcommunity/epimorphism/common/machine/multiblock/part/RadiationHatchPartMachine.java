...
public class RadiationHatchPartMachine extends TieredIOPartMachine implements IRecipeCapabilityHolder {
    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(RadiationHatchPartMachine.class, TieredIOPartMachine.MANAGED_FIELD_HOLDER);
