...
public class LargeNaquadahReactorMachine extends WorkableElectricMultiblockMachine implements IExplosionMachine {
    ...
    private static final FluidStack AIR = GTMaterials.LiquidAir.getFluid((FluidHelper.getBucket() / 1000) * 2400);
    ...
    public void onStructureFormed() {
        ...
        for (IMultiPart part : parts) {
            ...
            for (var handler : part.getRecipeHandlers()) {
                ...
                if (handler.getCapability() == FluidRecipeCapability.CAP && handler instanceof IFluidTransfer) {
    ...
    public GTRecipeType[] getRecipeTypes() {
        return new GTRecipeType[]{LARGE_NAQUADAH_REACTOR_FUELS};
    }
    ...
    public void addDisplayText(List<Component> textList) {
        ...
        if (isFormed()) {
            textList.add(Component.translatable("block.epimorphism.large_naquadah_reactor.real_eut", getRealEUt()));
        }
    }
    ...
    protected class ReactorLogic extends RecipeLogic {
        ...
        private static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(ReactorLogic.class, RecipeLogic.MANAGED_FIELD_HOLDER);
        ...
        public GTRecipe.ActionResult handleTickRecipe(GTRecipe recipe) {
            ...
            if ((totalContinuousRunningTime == 0 || totalContinuousRunningTime % 20 == 19)) {
                ...
                if (!(airRecipe.matchRecipe(machine).isSuccess() && airRecipe.handleRecipeIO(IO.IN, machine))) {
        ...
        protected void markDirtySearching() {
            // It's ugly, but I had to do it because of the logic issues with asynchronous thread recipe searching
            if (!isIdle()) {
