...
public class SuperSpaceLevelSource extends ChunkGenerator {
    public static final Codec<SuperSpaceLevelSource> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(RegistryOps.retrieveElement(EPBiomes.SUPER_SPACE)).apply(instance, instance.stable(SuperSpaceLevelSource::new))
    );
