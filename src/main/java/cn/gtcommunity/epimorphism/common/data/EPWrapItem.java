...
public class EPWrapItem {
    ...
    public final static ItemEntry<Item> WRAP_CIRCUIT_MV = registerWrapItem("wrap.circuit.mv", "Infinite Circuit Board", GTCEu.id("item/micro_processor"), MV_CIRCUITS);
    public final static ItemEntry<Item> WRAP_CIRCUIT_HV = registerWrapItem("wrap.circuit.hv", "Infinite Circuit Board", GTCEu.id("item/nano_processor"), HV_CIRCUITS);
    public final static ItemEntry<Item> WRAP_CIRCUIT_EV = registerWrapItem("wrap.circuit.ev", "Infinite Circuit Board", GTCEu.id("item/quantum_processor"), EV_CIRCUITS);
    public final static ItemEntry<Item> WRAP_CIRCUIT_IV = registerWrapItem("wrap.circuit.iv", "Infinite Circuit Board", GTCEu.id("item/crystal_processor"), IV_CIRCUITS);
    public final static ItemEntry<Item> WRAP_CIRCUIT_LuV = registerWrapItem("wrap.circuit.luv", "Infinite Circuit Board", GTCEu.id("item/wetware_processor"), LuV_CIRCUITS);
    public final static ItemEntry<Item> WRAP_CIRCUIT_ZPM = registerWrapItem("wrap.circuit.zpm", "Infinite Circuit Board", Epimorphism.id("item/circuit.gooware_processor"), ZPM_CIRCUITS);
    public final static ItemEntry<Item> WRAP_CIRCUIT_UV = registerWrapItem("wrap.circuit.uv", "Infinite Circuit Board", Epimorphism.id("item/circuit.optical_processor"), UV_CIRCUITS);
    public final static ItemEntry<Item> WRAP_CIRCUIT_UHV = registerWrapItem("wrap.circuit.uhv", "Infinite Circuit Board", Epimorphism.id("item/circuit.spintronic_processor"), UHV_CIRCUITS);
    public final static ItemEntry<Item> WRAP_CIRCUIT_UEV = registerWrapItem("wrap.circuit.uev", "Infinite Circuit Board", Epimorphism.id("item/circuit.cosmic_processor"), UEV_CIRCUITS);
    public final static ItemEntry<Item> WRAP_CIRCUIT_UIV = registerWrapItem("wrap.circuit.uiv", "Infinite Circuit Board", Epimorphism.id("item/circuit.supracausal_processor"), UIV_CIRCUITS);
    public final static ItemEntry<Item> WRAP_CIRCUIT_UXV = registerWrapItem("wrap.circuit.uxv", "Infinite Circuit Board", Epimorphism.id("item/circuit.supracausal_assembly"), UXV_CIRCUITS);
    public final static ItemEntry<Item> WRAP_CIRCUIT_OpV = registerWrapItem("wrap.circuit.opv", "Infinite Circuit Board", Epimorphism.id("item/circuit.supracausal_computer"), OpV_CIRCUITS);
    public final static ItemEntry<Item> CIRCUIT_MAX = registerWrapItem("wrap.circuit.max", "Infinite Circuit Board", Epimorphism.id("item/circuit.supracausal_mainframe"), MAX_CIRCUITS);
    ...
    public static ItemEntry<Item> WRAP_SMD_TRANSISTOR = registerWrapItem("wrap.component.smd_transistor", "Infinite Circuit Board", GTCEu.id("item/smd_transistor"), TRANSISTORS);
    public static ItemEntry<Item> WRAP_SMD_RESISTOR = registerWrapItem("wrap.component.smd_resistor", "Infinite Circuit Board", GTCEu.id("item/smd_resistor"), RESISTORS);
    public static ItemEntry<Item> WRAP_SMD_CAPACITOR = registerWrapItem("wrap.component.smd_capacitor", "Infinite Circuit Board", GTCEu.id("item/smd_capacitor"), CAPACITORS);
    public static ItemEntry<Item> WRAP_SMD_DIODE = registerWrapItem("wrap.component.smd_diode", "Infinite Circuit Board", GTCEu.id("item/smd_diode"), DIODES);
    public static ItemEntry<Item> WRAP_SMD_INDUCTOR = registerWrapItem("wrap.component.smd_inductor", "Infinite Circuit Board", GTCEu.id("item/smd_inductor"), INDUCTORS);
