...
public class EPBiomes {
    public static final ResourceKey<Biome> SUPER_SPACE = ResourceKey.create(Registries.BIOME, Epimorphism.id("super_space"));


    public static void bootstrap(BootstapContext<Biome> ctx) {
        ctx.register(SUPER_SPACE, space(ctx.lookup(Registries.PLACED_FEATURE), ctx.lookup(Registries.CONFIGURED_CARVER)));
    }
