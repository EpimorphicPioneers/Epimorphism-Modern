...
public class EPPhysicsItems {
    ...
    public static ItemEntry<Item> ENRICHED_URANIUM_NUGGET = registrate().item("enriched_uranium_nugget", Item::new).lang("Enriched Uranium Nugget").register();
    public static ItemEntry<Item> ENRICHED_URANIUM = registrate().item("enriched_uranium", Item::new).lang("Enriched Uranium").register();
    public static ItemEntry<Item> ENCAPSULATED_THORIUM = registrate().item("encapsulated_thorium", Item::new).lang("Encapsulated Thorium").register();
    public static ItemEntry<Item> ENRICHED_THORIUM_NUGGET = registrate().item("enriched_thorium_nugget", Item::new).lang("Enriched Thorium Nugget").register();
    public static ItemEntry<Item> ENRICHED_THORIUM = registrate().item("enriched_thorium", Item::new).lang("Enriched Thorium").register();
    public static ItemEntry<Item> ENCAPSULATED_PLUTONIUM = registrate().item("encapsulated_plutonium", Item::new).lang("Encapsulated Plutonium").register();
    public static ItemEntry<Item> ENRICHED_PLUTONIUM_NUGGET = registrate().item("enriched_plutonium_nugget", Item::new).lang("Enriched Plutonium Nugget").register();
    public static ItemEntry<Item> ENRICHED_PLUTONIUM = registrate().item("enriched_plutonium", Item::new).lang("Enriched Plutonium").register();

    public static ItemEntry<ComponentItem> NEUTRON_REFLECTOR = registerReactorComponent("neutron_reflector")
            .lang("Neutron Reflector")
            .onRegister(attach(new ReflectorBehavior(3000)))
            .register();
    public static ItemEntry<ComponentItem> THICK_NEUTRON_REFLECTOR = registerReactorComponent("thick_neutron_reflector")
            .lang("Thick Neutron Reflector")
            .onRegister(attach(new ReflectorBehavior(12000)))
            .register();
    public static ItemEntry<ComponentItem> IRIDIUM_REFLECTOR = registerReactorComponent("iridium_reflector")
    ...
    public static ItemEntry<ComponentItem> PLATING = registerReactorComponent("plating")
            ...
            .register();
    public static ItemEntry<ComponentItem> CONTAINMENT_PLATING = registerReactorComponent("containment_plating")
    ...
    public static ItemEntry<ComponentItem> HEAT_EXCHANGER = registerReactorComponent("heat_exchanger")
            ...
            .register();
    public static ItemEntry<ComponentItem> REACTOR_HEAT_EXCHANGER = registerReactorComponent("reactor_heat_exchanger")
            .lang("Reactor Heat Exchanger")
            .onRegister(attach(new ExchangerBehavior(5000, 0, 72)))
            .register();
    public static ItemEntry<ComponentItem> COMPONENT_HEAT_EXCHANGER = registerReactorComponent("component_heat_exchanger")
            .lang("Component Heat Exchanger")
            .onRegister(attach(new ExchangerBehavior(5000, 36, 0)))
            .register();
    public static ItemEntry<ComponentItem> ADVANCED_HEAT_EXCHANGER = registerReactorComponent("advanced_heat_exchanger")
    ...
    public static ItemEntry<ComponentItem> HEAT_VENT = registerReactorComponent("heat_vent")
            ...
            .register();
    public static ItemEntry<ComponentItem> REACTOR_HEAT_VENT = registerReactorComponent("reactor_heat_vent")
            .lang("Reactor Heat Vent")
            .onRegister(attach(new VentBehavior(1000, 5, 5, 0)))
            .register();
    public static ItemEntry<ComponentItem> COMPONENT_HEAT_VENT = registerReactorComponent("component_heat_vent")
            .lang("Component Heat Vent")
            .onRegister(attach(new VentBehavior(-1, 0, 0, 4)))
            .register();
    public static ItemEntry<ComponentItem> ADVANCED_HEAT_VENT = registerReactorComponent("advanced_heat_vent")
            .lang("Advanced Heat Vent")
            .onRegister(attach(new VentBehavior(1000, 12, 0, 0)))
            .register();
    public static ItemEntry<ComponentItem> OVERCLOCKED_HEAT_VENT = registerReactorComponent("overclocked_heat_vent")
            .lang("Overclocked Heat Vent")
            .onRegister(attach(new VentBehavior(1000, 20, 36, 0)))
            .register();
    public static ItemEntry<ComponentItem> WATER_COOLANT_CELL_10K = registerReactorComponent("water_coolant_cell_10k")
            .lang("Water Coolant Cell 10k")
            .onRegister(attach(new CoolantCellBehavior(10000)))
            .register();
    public static ItemEntry<ComponentItem> WATER_COOLANT_CELL_30K = registerReactorComponent("water_coolant_cell_30k")
            .lang("Water Coolant Cell 30k")
            .onRegister(attach(new CoolantCellBehavior(30000)))
            .register();
    public static ItemEntry<ComponentItem> WATER_COOLANT_CELL_60K = registerReactorComponent("water_coolant_cell_60k")
            .lang("Water Coolant Cell 60k")
            .onRegister(attach(new CoolantCellBehavior(60000)))
            .register();
    public static ItemEntry<ComponentItem> HELIUM_COOLANT_CELL_60K = registerReactorComponent("helium_coolant_cell_60k")
            .lang("Helium Coolant Cell 60k")
            .onRegister(attach(new CoolantCellBehavior(60000)))
            .register();
    public static ItemEntry<ComponentItem> HELIUM_COOLANT_CELL_180K = registerReactorComponent("helium_coolant_cell_180k")
            .lang("Helium Coolant Cell 180k")
            .onRegister(attach(new CoolantCellBehavior(180000)))
            .register();
    public static ItemEntry<ComponentItem> HELIUM_COOLANT_CELL_360K = registerReactorComponent("helium_coolant_cell_360k")
            .lang("Helium Coolant Cell 360k")
            .onRegister(attach(new CoolantCellBehavior(360000)))
            .register();
    public static ItemEntry<ComponentItem> NAK_COOLANT_CELL_60K = registerReactorComponent("nak_coolant_cell_60k")
            .lang("Nak Coolant Cell 60k")
            .onRegister(attach(new CoolantCellBehavior(60000)))
            .register();
    public static ItemEntry<ComponentItem> NAK_COOLANT_CELL_180K = registerReactorComponent("nak_coolant_cell_180k")
            .lang("Nak Coolant Cell 180k")
            .onRegister(attach(new CoolantCellBehavior(180000)))
            .register();
    public static ItemEntry<ComponentItem> NAK_COOLANT_CELL_360K = registerReactorComponent("nak_coolant_cell_360k")
    ...
    public static ItemEntry<ComponentItem> ROD_URANIUM = registerReactorComponent("rod_uranium")
            ...
            .register();
    public static ItemEntry<ComponentItem> ROD_DUAL_URANIUM = registerReactorComponent("rod_dual_uranium")
            .lang("Rod Dual Uranium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_QUAD_URANIUM = registerReactorComponent("rod_quad_uranium")
            .lang("Rod Quad Uranium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_URANIUM_MOX = registerReactorComponent("rod_uranium_mox")
            .lang("Rod Uranium Mox")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_DUAL_URANIUM_MOX = registerReactorComponent("rod_dual_uranium_mox")
            .lang("Rod Dual Uranium Mox")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_QUAD_URANIUM_MOX = registerReactorComponent("rod_quad_uranium_mox")
    ...
    public static ItemEntry<ComponentItem> ROD_THORIUM = registerReactorComponent("rod_thorium")
            ...
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_DUAL_THORIUM = registerReactorComponent("rod_dual_thorium")
            .lang("Rod Dual Thorium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_QUAD_THORIUM = registerReactorComponent("rod_quad_thorium")
    ...
    public static ItemEntry<ComponentItem> ROD_NAQUADAH = registerReactorComponent("rod_naquadah")
            ...
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_DUAL_NAQUADAH = registerReactorComponent("rod_dual_naquadah")
            .lang("Rod Dual Naquadah")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_QUAD_NAQUADAH = registerReactorComponent("rod_quad_naquadah")
    ...
    public static ItemEntry<ComponentItem> ROD_NAQUADRIA = registerReactorComponent("rod_naquadria")
            ...
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_DUAL_NAQUADRIA = registerReactorComponent("rod_dual_naquadria")
            .lang("Rod Dual Naquadria")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_QUAD_NAQUADRIA = registerReactorComponent("rod_quad_naquadria")
            .lang("Rod Quad Naquadria")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_ENRICHED_PLUTONIUM = registerReactorComponent("rod_enriched_plutonium")
            .lang("Rod Enriched Plutonium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_DUAL_ENRICHED_PLUTONIUM = registerReactorComponent("rod_dual_enriched_plutonium")
            .lang("Rod Dual Enriched Plutonium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_QUAD_ENRICHED_PLUTONIUM = registerReactorComponent("rod_quad_enriched_plutonium")
            .lang("Rod Quad Enriched Plutonium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_ENRICHED_URANIUM = registerReactorComponent("rod_enriched_uranium")
            .lang("Rod Enriched Uranium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_DUAL_ENRICHED_URANIUM = registerReactorComponent("rod_dual_enriched_uranium")
            .lang("Rod Dual Enriched Uranium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_QUAD_ENRICHED_URANIUM = registerReactorComponent("rod_quad_enriched_uranium")
            .lang("Rod Quad Enriched Uranium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_LIQUID_URANIUM = registerReactorComponent("rod_liquid_uranium")
            .lang("Rod Liquid Uranium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_DUAL_LIQUID_URANIUM = registerReactorComponent("rod_dual_liquid_uranium")
            .lang("Rod Dual Liquid Uranium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_QUAD_LIQUID_URANIUM = registerReactorComponent("rod_quad_liquid_uranium")
            .lang("Rod Quad Liquid Uranium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_LIQUID_PLUTONIUM = registerReactorComponent("rod_liquid_plutonium")
            .lang("Rod Luquid Plutonium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_DUAL_LIQUID_PLUTONIUM = registerReactorComponent("rod_dual_liquid_plutonium")
            .lang("Rod Dual Luquid Plutonium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();
    public static ItemEntry<ComponentItem> ROD_QUAD_LIQUID_PLUTONIUM = registerReactorComponent("rod_quad_liquid_plutonium")
            .lang("Rod Quad Luquid Plutonium")
            .onRegister(attach(new FuelRodBehavior(1, 1, 1, 1, false)))
            .register();

    public static ItemEntry<Item> ROD_EMPTY = registerItem("rod_empty").lang("Empty Fuel Rod").register();
    public static ItemEntry<Item> ROD_ADVANCED_EMPTY = registerItem("rod_advanced_empty").lang("Empty Advanced Fuel Rod").register();
    public static ItemEntry<Item> ROD_URANIUM_DEPLETED = registerItem("rod_uranium_depleted").lang("Rod Uranium Depleted").register();
    public static ItemEntry<Item> ROD_DUAL_URANIUM_DEPLETED = registerItem("rod_dual_uranium_depleted").lang("Rod Dual Uranium Depleted").register();
    public static ItemEntry<Item> ROD_QUAD_URANIUM_DEPLETED = registerItem("rod_quad_uranium_depleted").lang("Rod Quad Uranium Depleted").register();
    public static ItemEntry<Item> ROD_URANIUM_MOX_DEPLETED = registerItem("rod_uranium_mox_depleted").lang("Rod Uranium Mox Depleted").register();
    public static ItemEntry<Item> ROD_DUAL_URANIUM_MOX_DEPLETED = registerItem("rod_dual_uranium_mox_depleted").lang("Rod Dual Uranium Mox Depleted").register();
    public static ItemEntry<Item> ROD_QUAD_URANIUM_MOX_DEPLETED = registerItem("rod_quad_uranium_mox_depleted").lang("Rod Quad Uranium Mox Depleted").register();
    public static ItemEntry<Item> ROD_THORIUM_DEPLETED = registerItem("rod_thorium_depleted").lang("Rod Thorium Depleted").register();
    public static ItemEntry<Item> ROD_DUAL_THORIUM_DEPLETED = registerItem("rod_dual_thorium_depleted").lang("Rod Dual Thorium Depleted").register();
    public static ItemEntry<Item> ROD_QUAD_THORIUM_DEPLETED = registerItem("rod_quad_thorium_depleted").lang("Rod Quad Thorium Depleted").register();
    public static ItemEntry<Item> ROD_NAQUADAH_DEPLETED = registerItem("rod_naquadah_depleted").lang("Rod Naquadah Depleted").register();
    public static ItemEntry<Item> ROD_DUAL_NAQUADAH_DEPLETED = registerItem("rod_dual_naquadah_depleted").lang("Rod Dual Naquadah Depleted").register();
    public static ItemEntry<Item> ROD_QUAD_NAQUADAH_DEPLETED = registerItem("rod_quad_naquadah_depleted").lang("Rod Quad Naquadah Depleted").register();
    public static ItemEntry<Item> ROD_NAQUADRIA_DEPLETED = registerItem("rod_naquadria_depleted").lang("Rod Naquadria Depleted").register();
    public static ItemEntry<Item> ROD_DUAL_NAQUADRIA_DEPLETED = registerItem("rod_dual_naquadria_depleted").lang("Rod Dual Naquadria Depleted").register();
    public static ItemEntry<Item> ROD_QUAD_NAQUADRIA_DEPLETED = registerItem("rod_quad_naquadria_depleted").lang("Rod Quad Naquadria Depleted").register();
    public static ItemEntry<Item> ROD_ENRICHED_PLUTONIUM_DEPLETED = registerItem("rod_enriched_plutonium_depleted").lang("Rod Enriched Plutonium Depleted").register();
    public static ItemEntry<Item> ROD_DUAL_ENRICHED_PLUTONIUM_DEPLETED = registerItem("rod_dual_enriched_plutonium_depleted").lang("Rod Dual Enriched Plutonium Depleted").register();
    public static ItemEntry<Item> ROD_QUAD_ENRICHED_PLUTONIUM_DEPLETED = registerItem("rod_quad_enriched_plutonium_depleted").lang("Rod Quad Enriched Plutonium Depleted").register();
    public static ItemEntry<Item> ROD_ENRICHED_URANIUM_DEPLETED = registerItem("rod_enriched_uranium_depleted").lang("Rod Enriched Uranium Depleted").register();
    public static ItemEntry<Item> ROD_DUAL_ENRICHED_URANIUM_DEPLETED = registerItem("rod_dual_enriched_uranium_depleted").lang("Rod Dual Enriched Uranium Depleted").register();
    public static ItemEntry<Item> ROD_QUAD_ENRICHED_URANIUM_DEPLETED = registerItem("rod_quad_enriched_uranium_depleted").lang("Rod Quad Enriched Uranium Depleted").register();
    public static ItemEntry<Item> ROD_LIQUID_URANIUM_DEPLETED = registerItem("rod_liquid_uranium_depleted").lang("Rod Liquid Uranium Depleted").register();
    public static ItemEntry<Item> ROD_DUAL_LIQUID_URANIUM_DEPLETED = registerItem("rod_dual_liquid_uranium_depleted").lang("Rod Dual Liquid Uranium Depleted").register();
    public static ItemEntry<Item> ROD_QUAD_LIQUID_URANIUM_DEPLETED = registerItem("rod_quad_liquid_uranium_depleted").lang("Rod Quad Liquid Uranium Depleted").register();
    public static ItemEntry<Item> ROD_LIQUID_PLUTONIUM_DEPLETED = registerItem("rod_liquid_plutonium_depleted").lang("Rod Liquid Plutonium Depleted").register();
    ...
    private static ItemBuilder<ComponentItem, Registrate> registerParticleCapsule(String name, ParticleType particleType) {
        return registrate().item("particle_capsule." + name, ComponentItem::create)
    ...
    private static ItemBuilder<ComponentItem, Registrate> registerReactorComponent(String name) {
        return registrate().item(name, ComponentItem::create)
                .model(EPModels.simpleCustomModel(new ResourceLocation("item/generated"), Epimorphism.id("item/reactor_component/" + name)));
    }
