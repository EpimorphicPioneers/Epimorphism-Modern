...
public class EPOrganicChemistryMaterials {
    public static void register() {
        //  25000 Kapton-K
        EPMaterials.KaptonK = Builder("kapton_k")
                .ingot()
                .fluid()
                .color(16764498)
        ...
        //  25001 Kapton-E
        EPMaterials.KaptonE = Builder("kapton_e")
                .ingot()
                .fluid()
                .color(16768908)
        ...
        EPMaterials.PolystyreneSulfonate = Builder("polystyrene_sulfonate")
                .ingot()
                .fluid()
                .color(14777458)
                ...
                .buildAndRegister();
        //  25005  PEDOT:PSS
        EPMaterials.PedotPSS = Builder("pedot_pss")
                .ingot()
                .fluid()
                .color(14771623)
                ...
                .buildAndRegister();
        //  25006  PMMA
        EPMaterials.PMMA = Builder("polymethylmethacrylate")
                .ingot()
                .fluid()
                .color(9554657)
                ...
                .buildAndRegister();
        //  25007  PEDOT-TMA
        EPMaterials.PedotTMA = Builder("pedot_tma")
                .ingot()
                .fluid()
                .color(6201057)
        ...
        EPMaterials.TetramethylammoniumHydroxide = Builder("tetramethylammonium_hydroxide")
                .fluid()
                .color(4259798)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.PotassiumHydroxide = Builder("potassium_hydroxide")
                .dust()
        ...
        EPMaterials.PotassiumBromate = Builder("potassium_bromate")
                .dust()
                .color(0x782828)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
                ...
                .buildAndRegister();
        //  25011 Malonic Acid
        EPMaterials.MalonicAcid = Builder("malonic_acid")
                .dust()
                .color(0x61932E)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.ChloroaceticAcid = Builder("chloroacetic_acid")
                .dust()
                .color(0x38541A)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
                .iconSet(MaterialIconSet.SHINY)
        ...
        EPMaterials.Trichloroethylene = Builder("trichloroethylene")
                .fluid()
                .color(0xB685B1)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.Dichloroethane = Builder("dichloroethane")
                .fluid()
                .color(0xDAAED3)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.HydrobromicAcid = Builder("hydrobromic_acid")
                .fluid(FluidStorageKeys.LIQUID, new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x8D1212)
                .components(GTMaterials.Hydrogen, 1, GTMaterials.Bromine, 1)
                .buildAndRegister();
        //  25016 Butanediol
        EPMaterials.Butanediol = Builder("butanediol")
                .fluid()
                .color(0xAAC4DA)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.SulfurDichloride = Builder("sulfur_dichloride")
                .fluid()
                .color(0x761410)
                .components(GTMaterials.Sulfur, 1, GTMaterials.Chlorine, 2)
                .buildAndRegister();
        //  25020 Acetone Cyanohydrin
        EPMaterials.AcetoneCyanohydrin = Builder("acetone_cyanohydrin")
                .fluid()
                .color(0xA1FFD0)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
                ...
                .buildAndRegister();
        //  25021 Para Xylene
        EPMaterials.ParaXylene = Builder("para_xylene")
                .fluid()
                .color(0x666040)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.Cycloparaphenylene = Builder("cycloparaphenylene")
                .fluid()
                .color(0x60545A)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.Dichlorocyclooctadieneplatinium = Builder("dichlorocyclooctadieneplatinium")
                .dust()
                .color(0xD4E982)
        ...
        EPMaterials.Diiodobiphenyl = Builder("diiodobiphenyl")
                .dust()
                .color(0x000C52)
        ...
        //  25025 Bipyridine
        EPMaterials.Bipyridine = Builder("bipyridine")
                .dust()
                .color(0x716449)
        ...
        EPMaterials.PalladiumBisdibenzylidieneacetone = Builder("palladium_bisdibenzylidieneacetone")
                .dust()
                .color(0x996881)
                .iconSet(MaterialIconSet.METALLIC)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.Polyetheretherketone = Builder("polyetheretherketone")
                .polymer()
                .color(0x45433D)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION, MaterialFlags.NO_SMASHING, MaterialFlags.NO_SMELTING, MaterialFlags.GENERATE_PLATE)
        ...
        EPMaterials.Difluorobenzophenone = Builder("difluorobenzophenone")
                .dust()
                .color(0xC44DA5)
                .iconSet(MaterialIconSet.SHINY)
        ...
        //  25038 Hydroquinone
        EPMaterials.Hydroquinone = Builder("hydroquinone")
                .fluid()
                .color(0x83251A)
        ...
        //  25039 Resorcinol
        EPMaterials.Resorcinol = Builder("resorcinol")
                .fluid()
                .color(0x9DA38D)
                .components(GTMaterials.Carbon, 6, GTMaterials.Hydrogen, 6, GTMaterials.Oxygen, 2)
                .buildAndRegister();
        //  25040 Fluorobenzene
        EPMaterials.Fluorobenzene = Builder("fluorobenzene")
                .fluid()
                .color(0x7CCA88)
                .components(GTMaterials.Carbon, 6, GTMaterials.Hydrogen, 5, GTMaterials.Fluorine, 1)
                .buildAndRegister();
        //  25041 Fluorotoluene
        EPMaterials.Fluorotoluene = Builder("fluorotoluene")
                .fluid()
                .color(0x6EC5B8)
                .components(GTMaterials.Carbon, 7, GTMaterials.Hydrogen, 7, GTMaterials.Fluorine, 1)
                .buildAndRegister();
        //  25042 Kevlar
        EPMaterials.Kevlar = Builder("kevlar")
                .polymer()
                .color(0xF0F078)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION, MaterialFlags.NO_SMASHING, MaterialFlags.NO_SMELTING, MaterialFlags.GENERATE_PLATE)
        ...
        EPMaterials.ParaPhenylenediamine = Builder("para_phenylenediamine")
                .dust()
                .color(0x4A8E7B)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        EPMaterials.TerephthaloylChloride = Builder("terephthaloyl_chloride")
                .dust()
                .color(0xFAC4DA)
                .iconSet(MaterialIconSet.SHINY)
        ...
        EPMaterials.NMethylPyrrolidone = Builder("n_methyl_pyrrolidone")
                .fluid()
                .color(0xA504D6)
                .components(GTMaterials.Carbon, 5, GTMaterials.Hydrogen, 9, GTMaterials.Nitrogen, 1, GTMaterials.Oxygen, 1)
                .buildAndRegister();
        //  25046 Nitroaniline
        EPMaterials.Nitroaniline = Builder("nitroaniline")
                .fluid()
                .color(0x2A6E68)
        ...
        //  25047 Durene
        EPMaterials.Durene = Builder("durene")
                .dust()
                .color(0x336040)
        ...
        EPMaterials.PyromelliticDianhydride = Builder("pyromellitic_dianhydride")
                .dust()
                .color(0xF0EAD6)
                .iconSet(MaterialIconSet.ROUGH)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        //  25049 Oxydianiline
        EPMaterials.Oxydianiline = Builder("oxydianiline")
                .dust()
                .color(0xF0E130)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
                .components(GTMaterials.Carbon, 12, GTMaterials.Hydrogen, 12, GTMaterials.Nitrogen, 2, GTMaterials.Oxygen, 1)
        ...
        EPMaterials.Dimethylformamide = Builder("dimethylformamide")
                .fluid()
                .color(0x42BDFF)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.PhthalicAnhydride = Builder("phthalic_anhydride")
                .dust()
                .color(0xEEAAEE)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.BiphenylTetracarboxylicAcidDianhydride = Builder("biphenyl_tetracarboxylic_acid_dianhydride")
                .dust()
                .color(0xFF7F50)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.Bistrichloromethylbenzene = Builder("bistrichloromethylbenzene")
                .fluid()
                .color(0xCF8498)
        ...
        EPMaterials.Tetrabromoethane = Builder("tetrabromoethane")
                .fluid()
                .color(0x5AAADA)
                .components(GTMaterials.Carbon, 2, GTMaterials.Hydrogen, 2, GTMaterials.Bromine, 4)
                .buildAndRegister();
        //  25055 Terephthalic Acid
        EPMaterials.TerephthalicAcid = Builder("terephthalic_acid")
                .dust()
                .color(0x5ACCDA)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        EPMaterials.GammaButyrolactone = Builder("gamma_butyrolactone")
                .fluid()
                .color(0xAF04D6)
                .components(GTMaterials.Carbon, 4, GTMaterials.Hydrogen, 6, GTMaterials.Oxygen, 2)
                .buildAndRegister();
        //  25057 Methylamine
        EPMaterials.Methylamine = Builder("methylamine")
                .gas()
                .color(0xAA6600)
        ...
        EPMaterials.Trimethylaluminium = Builder("trimethylaluminium")
                .fluid()
                .color(0x6ECCFF)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.Trimethylgallium = Builder("trimethylgallium")
                .fluid()
                .color(0x4F92FF)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.Benzophenanthrenylacetonitrile = Builder("benzophenanthrenylacetonitrile")
                .dust()
                .color(0xBB58E9)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        EPMaterials.Methylbenzophenanthrene = Builder("methylbenzophenanthrene")
                .dust()
                .color(0xEA236B)
                .iconSet(MaterialIconSet.DULL)
        ...
        EPMaterials.BromoSuccinimide = Builder("bromo_succinimide")
                .dust()
                .color(0x00BF8C)
                .iconSet(MaterialIconSet.ROUGH)
                ...
                .buildAndRegister();
        //  25063 Succinimide
        EPMaterials.Succinimide = Builder("succinimide")
                .dust()
                .color(0x1774B6)
                .iconSet(MaterialIconSet.ROUGH)
                ...
                .buildAndRegister();
        //  25064 Succinic Acid
        EPMaterials.SuccinicAcid = Builder("succinic_acid")
                .dust()
                .color(0x0C3A5B)
                .iconSet(MaterialIconSet.DULL)
        ...
        EPMaterials.MaleicAnhydride = Builder("maleic_anhydride")
                .fluid()
                .color(0x610C2F)
                .components(GTMaterials.Carbon, 4, GTMaterials.Hydrogen, 2, GTMaterials.Oxygen, 3)
                .buildAndRegister();
        //  25066 Naphthaldehyde
        EPMaterials.Naphthaldehyde = Builder("naphthaldehyde")
                .fluid()
                .color(0x00FFED)
        ...
        //  25067 Butanol
        EPMaterials.Butanol = Builder("butanol")
                .fluid()
                .color(0xC7AF2E)
        ...
        //  25068 Bromobutane
        EPMaterials.Bromobutane = Builder("bromobutane")
                .fluid()
                .color(0xAE0E39)
        ...
        EPMaterials.Cyanonaphthalene = Builder("cyanonaphthalene")
                .dust()
                .color(0xDE992D)
                .iconSet(MaterialIconSet.DULL)
        ...
        EPMaterials.Triphenylphosphine = Builder("triphenylphosphine")
                .dust()
                .color(0x8F2C6B)
                .iconSet(MaterialIconSet.BRIGHT)
        ...
        EPMaterials.Ethylanthraquinone = Builder("ethylanthraquinone")
                .fluid()
                .color(0xCC865A)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.Ethylanthrahydroquinone = Builder("ethylanthrahydroquinone")
                .fluid()
                .color(0xAD531A)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.Ethylenediamine = Builder("ethylenediamine")
                .fluid()
                .color(0xD00ED0)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.TetrasodiumEDTA = Builder("tetrasodium_edta")
                .dust()
                .color(0x8890E0)
                .iconSet(MaterialIconSet.SHINY)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.EthylenediaminetetraaceticAcid = Builder("ethylenediaminetetraacetic_acid")
                .dust()
                .fluid()
                .color(0x87E6D9)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        EPMaterials.TetramethylammoniumChloride = Builder("tetramethylammonium_chloride")
                .dust()
                .color(0x27FF81)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        EPMaterials.Trimethylamine = Builder("trimethylamine")
                .gas()
                .color(0xBB7700)
        ...
        //  25078 Pyrocatechol
        EPMaterials.Pyrocatechol = Builder("pyrocatechol")
                .dust()
                .color(0x784421)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
                .iconSet(MaterialIconSet.DULL)
        ...
        EPMaterials.NitrylFluoride = Builder("nitryl_fluoride")
                .fluid()
                .color(0x8B7EFF)
        ...
        EPMaterials.DimethylamineHydrochloride = Builder("dimethylamine_hydrochloride")
                .fluid()
                .color(0xE3EBDC)
        ...
        EPMaterials.Dimethylcadmium = Builder("dimethylcadmium")
                .fluid()
                .color(0x5C037F)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.BETSPerrhenate = Builder("bets_perrhenate")
                .dust()
                .color(0x98E993)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
                .iconSet(MaterialIconSet.SHINY)
        ...
        EPMaterials.Bisethylenedithiotetraselenafulvalene = Builder("bisethylenedithiotetraselenafulvalene")
                .dust()
                .color(0x98E993)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        EPMaterials.Lithiumthiinediselenide = Builder("lithiumthiinediselenide")
                .dust()
                .color(0x689E64)
                .iconSet(MaterialIconSet.DULL)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.CyclopentadienylTitaniumTrichloride = Builder("cyclopentadienyl_titanium_trichloride")
                .dust()
                .color(0x752C7A)
                .iconSet(MaterialIconSet.BRIGHT)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        //  25088 Propadiene
        EPMaterials.Propadiene = Builder("propadiene")
                .fluid()
                .color(0xBD8F61)
                .components(GTMaterials.Carbon, 3, GTMaterials.Hydrogen, 4)
                .buildAndRegister();
        //  25089 Barium Triflate
        EPMaterials.BariumTriflate = Builder("barium_triflate")
                .dust()
                .color(0xFFC183)
                .iconSet(MaterialIconSet.BRIGHT)
        ...
        EPMaterials.ScandiumTriflate = Builder("scandium_triflate")
                .dust()
                .color(0xCC9999)
                .iconSet(MaterialIconSet.BRIGHT)
        ...
        EPMaterials.BariumTriflateSolution = Builder("barium_triflate_solution")
                .fluid()
                .color(0xFFC183)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
                .buildAndRegister()
        ...
        EPMaterials.SodiumFormate = Builder("sodium_formate")
                ...
                .buildAndRegister();
        //  25099 Ethylhexanol
        EPMaterials.Ethylhexanol = Builder("ethylhexanol")
                .fluid()
                .color(0xFEEA9A)
                .components(GTMaterials.Carbon, 8, GTMaterials.Hydrogen, 10, GTMaterials.Oxygen, 1)
                .buildAndRegister();
        //  25100 Diethylhexyl Phosphoric Acid
        EPMaterials.DiethylhexylPhosphoricAcid = Builder("diethylhexyl_phosphoric_acid")
                .fluid()
                .color(0xFFFF99)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.Dichloromethane = Builder("dichloromethane")
                .fluid()
                .color(0xB87FC7)
                .components(GTMaterials.Carbon, 1, GTMaterials.Hydrogen, 2, GTMaterials.Chlorine, 2)
                .buildAndRegister();
        //  25102 Tributylamine
        EPMaterials.Tributylamine = Builder("tributylamine")
                .fluid()
                .color(0x801a80)
        ...
        //  25103 Zylon
        EPMaterials.Zylon = Builder("zylon")
                .polymer()
                .color(0xFFE000)
                .iconSet(MaterialIconSet.SHINY)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION, MaterialFlags.NO_SMASHING, MaterialFlags.NO_SMELTING, MaterialFlags.GENERATE_PLATE, MaterialFlags.GENERATE_FOIL)
                ...
                .buildAndRegister();
        //  25104 Pre Zylon
        EPMaterials.PreZylon = Builder("pre_zylon")
                .dust()
                .color(0x623250)
                .iconSet(MaterialIconSet.DULL)
        ...
        EPMaterials.Terephthalaldehyde = Builder("terephthalaldehyde")
                .dust()
                .color(0x567C2D)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        EPMaterials.Dibromomethylbenzene = Builder("dibromomethylbenzene")
                .fluid()
                .color(0x9F4839)
                .components(GTMaterials.Carbon, 7, GTMaterials.Hydrogen, 6, GTMaterials.Bromine, 2)
                .buildAndRegister();
        //  25107 Isochloropropane
        EPMaterials.Isochloropropane = Builder("isochloropropane")
                .fluid()
                .color(0xC3AC65)
        ...
        EPMaterials.Dinitrodipropanyloxybenzene = Builder("dinitrodipropanyloxybenzene")
                .fluid()
                .color(0x9FAD1D)
        ...
        EPMaterials.Hexanitrohexaaxaisowurtzitane = Builder("hexanitrohexaaxaisowurtzitane")
                .dust()
                .color(0x0B7222)
                .iconSet(MaterialIconSet.BRIGHT)
        ...
        EPMaterials.CrudeHexanitrohexaaxaisowurtzitane = Builder("crude_hexanitrohexaaxaisowurtzitane")
                .dust()
                .color(0x5799EC)
                .iconSet(MaterialIconSet.DULL)
                .components(GTMaterials.Carbon, 6, GTMaterials.Hydrogen, 6, GTMaterials.Nitrogen, 12, GTMaterials.Oxygen, 12)
        ...
        EPMaterials.Tetraacetyldinitrosohexaazaisowurtzitane = Builder("tetraacetyldinitrosohexaazaisowurtzitane")
                .dust()
                .color(0xEA7584)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        EPMaterials.Dibenzyltetraacetylhexaazaisowurtzitane = Builder("dibenzyltetraacetylhexaazaisowurtzitane")
                .dust()
                .color(0xB7E8EE)
                .iconSet(MaterialIconSet.DULL)
        ...
        EPMaterials.SuccinimidylAcetate = Builder("succinimidyl_acetate")
                .dust()
                .color(0x1D3605)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        EPMaterials.NHydroxysuccinimide = Builder("n_hydroxysuccinimide")
                .dust()
                .color(0x33BAFB)
                .iconSet(MaterialIconSet.DULL)
        ...
        EPMaterials.Tetrahydrofuran = Builder("tetrahydrofuran")
                .fluid()
                .color(0x0BCF52)
        ...
        EPMaterials.SuccinicAnhydride = Builder("succinic_anhydride")
                .dust()
                .color(0xA2569D)
        ...
        EPMaterials.Hexabenzylhexaazaisowurtzitane = Builder("hexabenzylhexaazaisowurtzitane")
                .dust()
                .color(0x48561E)
                .iconSet(MaterialIconSet.DULL)
                ...
                .buildAndRegister();
        //  25118 Acetonitrile
        EPMaterials.Acetonitrile = Builder("acetonitrile")
                .dust()
                .color(0x7D82A3)
                .iconSet(MaterialIconSet.ROUGH)
                ...
                .setFormula("CH3CN");
        //  25119 Acetamide
        EPMaterials.Acetamide = Builder("acetamide")
                .dust()
                .color(0x7D82A3)
                .iconSet(MaterialIconSet.DULL)
        ...
        EPMaterials.DimethylCarbonate = Builder("dimethyl_carbonate")
                .fluid()
                .color(0xC5EB9E)
        ...
        EPMaterials.DiphenylCarbonate = Builder("diphenyl_carbonate")
                .fluid()
        ...
        EPMaterials.BPAPolycarbonate = Builder("bpa_polycarbonate")
                .ingot()
                .fluid()
                .color(0xE3EBDA)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION, MaterialFlags.NO_SMASHING, MaterialFlags.NO_SMELTING, MaterialFlags.GENERATE_PLATE)
        ...
        EPMaterials.IsobutyricAcid = Builder("isobutyric_acid")
                .fluid()
        ...
        EPMaterials.IsobutyricAnhydride = Builder("isobutyric_anhydride")
                .fluid()
        ...
        EPMaterials.Dimethylketene = Builder("dimethylketene")
                .fluid()
                .color(0x0925BE)
                .components(GTMaterials.Carbon, 4, GTMaterials.Hydrogen, 6, GTMaterials.Oxygen, 2)
                .buildAndRegister();
        //  25129 Tetramethylcyclobutanediol
        EPMaterials.Tetramethylcyclobutanediol = Builder("tetramethylcyclobutanediol")
                .fluid()
        ...
        EPMaterials.CBDOPolycarbonate = Builder("cbdo_polycarbonate")
                .ingot()
                .fluid()
                .color(0xDFDFDF)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION, MaterialFlags.NO_SMASHING, MaterialFlags.NO_SMELTING, MaterialFlags.GENERATE_PLATE)
        ...
        EPMaterials.NitrileButadieneRubber = Builder("nitrile_butadiene_rubber")
        ...
        EPMaterials.PolyPhosphonitrileFluoroRubber = Builder("poly_phosphonitrile_fluoro_rubber")
                .polymer()
                .color(0x372B28)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION, MaterialFlags.GENERATE_PLATE, MaterialFlags.GENERATE_RING)
                ...
                .buildAndRegister();
        //  25133 Acrylonitrile
        EPMaterials.Acrylonitrile = Builder("acrylonitrile")
                .fluid()
        ...
        EPMaterials.PhosphonitrilicChlorideTrimer = Builder("phosphonitrilic_chloride_trimer")
                .fluid()
                .color(0x082C38)
        ...
        EPMaterials.SodiumTrifluoroethanolate = Builder("sodium_trifluoroethanolate")
                .dust()
                .color(0x50083E)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        EPMaterials.OctafluoroPentanol = Builder("octafluoro_pentanol")
                .fluid()
                .color(0xE5EBDE)
        ...
        EPMaterials.TributylPhosphate = Builder("tributyl_phosphate")
                .fluid()
                .color(0xBED323)
        ...
        EPMaterials.MethylIsobutylKetone = Builder("methyl_isobutyl_ketone")
                .fluid()
                .color(0x2F5687)
                .components(GTMaterials.Carbon, 6, GTMaterials.Hydrogen, 12, GTMaterials.Oxygen, 1)
                .buildAndRegister();
        //  25139 tbp_mibk_solution
        EPMaterials.TBPMIBKSolution = Builder("tbp_mibk_solution")
                .fluid()
                ...
                .buildAndRegister();
        //  25140 Mesityl Oxide
        EPMaterials.MesitylOxide = Builder("mesityl_oxide")
                .fluid()
                .color(0x783E50)
                .components(GTMaterials.Carbon, 6, GTMaterials.Hydrogen, 10, GTMaterials.Oxygen, 1)
                .buildAndRegister();
        //  25141 Electrolyte Reflector Mixture
        EPMaterials.ElectrolyteReflectorMixture = Builder("electrolyte_reflector_mixture")
        ...
        EPMaterials.EthyleneDibromide = Builder("ethylene_dibromide")
                .fluid()
                .color(0x4F1743)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.GrignardReagent = Builder("grignard_reagent")
                .fluid()
                .color(0xA12AA1)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.Fluorocarborane = Builder("fluorocarborane")
                .dust()
                .color(0x59B35C)
                .iconSet(MaterialIconSet.BRIGHT)
        ...
        EPMaterials.Perfluorobenzene = Builder("perfluorobenzene")
                .fluid()
                .color(0x39733B)
        ...
        EPMaterials.Trimethylsilane = Builder("trimethylsilane")
                .fluid()
                .color(0xB366B0)
                .components(GTMaterials.Carbon, 3, GTMaterials.Hydrogen, 10, GTMaterials.Silicon, 1)
                .buildAndRegister();
        //  25147 Trimethylchlorosilane
        EPMaterials.Trimethylchlorosilane = Builder("trimethylchlorosilane")
                .fluid()
                .color(0x864D84)
        ...
        EPMaterials.CaesiumCarboranePrecursor = Builder("caesium_carborane_precursor")
                .dust()
        ...
        EPMaterials.BoraneDimethylsulfide = Builder("borane_dimethylsulfide")
                .fluid()
                ...
                .buildAndRegister();
        //  25150 Decaborane
        EPMaterials.Decaborane = Builder("decaborane")
                .dust()
                .color(0x4C994F)
                .iconSet(MaterialIconSet.ROUGH)
                ...
                .buildAndRegister();
        //  25151 Diethyl Ether
        EPMaterials.DiethylEther = Builder("diethyl_ether")
                .fluid()
                .color(0xFFA4A3)
                .components(GTMaterials.Carbon, 4, GTMaterials.Hydrogen, 10, GTMaterials.Oxygen, 1)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.BoronTrifluorideEtherate = Builder("boron_trifluoride_etherate")
                .fluid()
                .color(0xBF6E6E)
        ...
        EPMaterials.DimethylSulfide = Builder("dimethyl_sulfide")
                .fluid()
        ...
        //  25154 Oxalic Acid
        EPMaterials.OxalicAcid = Builder("oxalic_acid")
                .fluid()
                .color(0xC5EB9E)
        ...
        //  25155 Glucose
        EPMaterials.Glucose = Builder("glucose")
                .dust()
                .color(0xE3E3E3)
                .iconSet(MaterialIconSet.SAND)
                ...
                .buildAndRegister();
        //  25156 Fructose
        EPMaterials.Fructose = Builder("fructose")
                .dust()
                .color(0xE3E3E3)
                .iconSet(MaterialIconSet.SAND)
                .components(GTMaterials.Carbon, 6, GTMaterials.Hydrogen, 12, GTMaterials.Oxygen, 6)
        ...
        EPMaterials.Hexafluoropropylene = Builder("hexafluoropropylene")
                .fluid()
                .color(0x141D6F)
                .components(GTMaterials.Carbon, 3, GTMaterials.Fluorine, 6)
                .buildAndRegister();
        //  25158 Fluorinated Ethylene Propylene
        EPMaterials.FluorinatedEthylenePropylene = Builder("fluorinated_ethylene_propylene")
                .polymer()
                .color(0xC8C8C8)
                .iconSet(MaterialIconSet.DULL)
        ...
        EPMaterials.PolycyclicAromaticMixture = Builder("polycyclic_aromatic_mixture")
                .dust()
                .color(0x95A36C)
                .iconSet(MaterialIconSet.ROUGH)
                ...
                .buildAndRegister();
        //  25160 Anthracene
        EPMaterials.Anthracene = Builder("anthracene")
                .fluid()
                .color(0xCCCC99)
                .components(GTMaterials.Carbon, 14, GTMaterials.Hydrogen, 10)
                .buildAndRegister();
        //  25161 Dihydroiodotetracene
        EPMaterials.Dihydroiodotetracene = Builder("dihydroiodotetracene")
                .fluid()
                .color(0xA1DF62)
        ...
        EPMaterials.Dimethylnaphthalene = Builder("dimethylnaphthalene")
                .fluid()
                .color(0xF200FF)
                .components(GTMaterials.Carbon, 12, GTMaterials.Hydrogen, 12)
                .buildAndRegister();
        //  25163 Acetylating Reagent
        EPMaterials.AcetylatingReagent = Builder("acetylating_reagent")
                .fluid()
                .color(0x500C45)
        ...
        EPMaterials.Dichlorodicyanobenzoquinone = Builder("dichlorodicyanobenzoquinone")
                .fluid()
                .color(0x47BFA6)
                .flags(MaterialFlags.DISABLE_DECOMPOSITION)
        ...
        EPMaterials.Dichlorodicyanohydroquinone = Builder("dichlorodicyanohydroquinone")
                .fluid()
                .color(0x1BC3A2)
        ...
        EPMaterials.IsopropylAlcohol = Builder("isopropyl_alcohol")
                .fluid()
                .color(0xFF23D4)
                .components(GTMaterials.Carbon, 3, GTMaterials.Hydrogen, 8, GTMaterials.Oxygen, 1)
                .buildAndRegister();
        //  25167 Tetracene
        EPMaterials.Tetracene = Builder("tetracene")
                .dust()
                .color(0x9B8E35)
                .iconSet(MaterialIconSet.SHINY)
                .components(GTMaterials.Carbon, 18, GTMaterials.Hydrogen, 12)
