...
public class EPUnknownCompositionMaterials {
    public static void register() {
        ...
        RichNitrogenMixture = Builder("rich_nitrogen_mixture")
                .gas()
                .color(0x6891D8)
                .buildAndRegister();
        //  25204 Rich Ammonia Mixture
        RichAmmoniaMixture = Builder("rich_ammonia_mixture")
                .fluid()
                .color(0x708ACD)
                .buildAndRegister();
        ...
        PhosphoreneSolution = Builder("phosphorene_solution")
                .fluid()
                .color(0x465966)
                .buildAndRegister();
        //  25209 Methylamine Mixture
        MethylamineMixture = Builder("methylamine_mixture")
                .fluid()
                .color(0xAA4400)
                .buildAndRegister();
        //  25210 Molybdenum Flue
        MolybdenumFlue = Builder("molybdenum_flue")
                .gas()
                .color(0x39194A)
                .buildAndRegister();
        //  25211 Trace Rhenium Flue
        TraceRheniumFlue = Builder("trace_rhenium_flue")
                .gas()
                .color(0x96D6D5)
                .buildAndRegister();
        ...
        HeavyNaquadahFuel = Builder("heavy_naquadah_fuel")
                .fluid()
                .color(0x088C56)
                .buildAndRegister();
        //  25218 Medium Naquadah Fuel
        MediumNaquadahFuel = Builder("medium_naquadah_fuel")
                .fluid()
                .color(0x09A566)
                .buildAndRegister();
        //  25219 Light Naquadah Fuel
        LightNaquadahFuel = Builder("light_naquadah_fuel")
                .fluid()
                .color(0x0BBF75)
                .buildAndRegister();
        //  25220 Naquadah Gas
...
//                .iconSet(GAS)
        ...
        FracturingFluid = Builder("fracturing_fluid")
                .fluid()
                .color(0x96D6D5)
                .buildAndRegister();
        //  25222 Bedrock
        Bedrock = Builder("bedrock")
                ...
                .buildAndRegister();
        //  25223 Bedrock Smoke
        BedrockSmoke = Builder("bedrock_smoke")
                .gas()
                .color(0x525252)
                .buildAndRegister();
        //  25224 Bedrock Soot Solution
        BedrockSootSolution = Builder("bedrock_soot_solution")
                .fluid()
                .color(0x1E2430)
                .buildAndRegister();
        //  25225 Clean Bedrock Solution
        CleanBedrockSolution = Builder("clean_bedrock_solution")
                .fluid()
                .color(0xA89F9E)
                .buildAndRegister();
        //  25226 Heavy Bedrock Smoke
        HeavyBedrockSmoke = Builder("heavy_bedrock_smoke")
                .gas()
                .color(0x242222)
                .buildAndRegister();
        //  25227 Medium Bedrock Smoke
        MediumBedrockSmoke = Builder("medium_bedrock_smoke")
                .gas()
                .color(0x2E2C2C)
                .buildAndRegister();
        //  25228 Light Bedrock Smoke
        LightBedrockSmoke = Builder("light_bedrock_smoke")
                .gas()
                .color(0x363333)
                .buildAndRegister();
        //  25229 Ultralight Bedrock Smoke
        UltralightBedrockSmoke = Builder("ultralight_bedrock_smoke")
                .gas()
                .color(0x403D3D)
                .buildAndRegister();
        //  25230 Heavy Taranium Gas
        HeavyTaraniumGas = Builder("heavy_taranium_gas")
                .gas()
                .color(0x262626)
                .buildAndRegister();
        //  25231 Medium Taranium Gas
        MediumTaraniumGas = Builder("medium_taranium_gas")
                .gas()
                .color(0x313131)
                .buildAndRegister();
        //  25232 Light Taranium Gas
        LightTaraniumGas = Builder("light_taranium_gas")
                .gas()
                .color(0x404040)
                .buildAndRegister();
        //  25233 Bedrock Gas
        BedrockGas = Builder("bedrock_gas")
                .gas()
                .color(0x575757)
                .buildAndRegister();
        //  25234 Cracked Heavy Taranium
        CrackedHeavyTaranium = Builder("cracked_heavy_taranium")
                .fluid()
                .color(0x1F2B2E)
                .buildAndRegister();
        //  25235 Cracked Medium Taranium
        CrackedMediumTaranium = Builder("cracked_medium_taranium")
                .fluid()
                .color(0x29393D)
                .buildAndRegister();
        //  25236 Cracked Light Taranium
        CrackedLightTaranium = Builder("cracked_light_taranium")
                .fluid()
                .color(0x374C52)
                .buildAndRegister();
        //  25237 Enriched Bedrock Soot Solution
        EnrichedBedrockSootSolution = Builder("enriched_bedrock_soot_solution")
                .fluid()
                .color(0x280C26)
                .buildAndRegister();
        //  25238 Clean Enriched Bedrock Solution
        CleanEnrichedBedrockSolution = Builder("clean_enriched_bedrock_solution")
                .fluid()
                .color(0x828C8C)
                .buildAndRegister();
        //  25239 Heavy Enriched Bedrock Smoke
        HeavyEnrichedBedrockSmoke = Builder("heavy_enriched_bedrock_smoke")
                .gas()
                .color(0x1A2222)
                .buildAndRegister();
        //  25240 Medium Enriched Bedrock Smoke
        MediumEnrichedBedrockSmoke = Builder("medium_enriched_bedrock_smoke")
                .gas()
                .color(0x1E2C2C)
                .buildAndRegister();
        //  25241 Light Enriched Bedrock Smoke
        LightEnrichedBedrockSmoke = Builder("light_enriched_bedrock_smoke")
                .gas()
                .color(0x163333)
                .buildAndRegister();
        //  25242 Heavy Enriched Taranium Gas
        HeavyEnrichedTaraniumGas = Builder("heavy_enriched_taranium_gas")
                .gas()
                .color(0x1F2626)
                .buildAndRegister();
        //  25243 Medium Enriched Taranium Gas
        MediumEnrichedTaraniumGas = Builder("medium_enriched_taranium_gas")
                .gas()
                .color(0x1F3131)
                .buildAndRegister();
        //  25244 Light Enriched Taranium Gas
        LightEnrichedTaraniumGas = Builder("light_enriched_taranium_gas")
                .gas()
                .color(0x1F4040)
                .buildAndRegister();
        //  25245 Cracked Heavy Enriched Taranium
        CrackedHeavyEnrichedTaranium = Builder("cracked_heavy_enriched_taranium")
                .fluid()
                .color(0x2E1F2E)
                .buildAndRegister();
        //  25246 Cracked Medium Enriched Taranium
        CrackedMediumEnrichedTaranium = Builder("cracked_medium_enriched_taranium")
                .fluid()
                .color(0x29393D)
                .buildAndRegister();
        //  25247 Cracked Light Enriched Taranium
        CrackedLightEnrichedTaranium = Builder("cracked_light_enriched_taranium")
                .fluid()
                .color(0x374C52)
                .buildAndRegister();
        //  25248 Energetic Naquadria
        EnergeticNaquadria = Builder("energetic_naquadria")
                .fluid()
                .color(0x202020)
                .buildAndRegister();
        //  25249 Light Hyper Fuel
        LightHyperFuel = Builder("light_hyper_fuel")
                .fluid()
                .color(0x8C148C)
                .buildAndRegister();
        //  25250 Medium Hyper Fuel
        MediumHyperFuel = Builder("medium_hyper_fuel")
                .fluid()
                .color(0xDC0A0A)
                .buildAndRegister();
        //  25251 Heavy Hyper Fuel
        HeavyHyperFuel = Builder("heavy_hyper_fuel")
                .fluid()
                .color(0x1E5064)
                .buildAndRegister();
        ...
        RoughlyPurifiedRareEarthChloridesSolution = Builder("roughly_purified_rare_earth_chlorides_solution")
                .fluid()
                .color(0xA2A27F)
                .iconSet(MaterialIconSet.DULL)
                .flags(DISABLE_DECOMPOSITION)
        ...
        ResidualDraconiumSolution = Builder("residual_draconium_solution")
                .fluid()
                .color(0x4321C5)
                .buildAndRegister();
        ...
        HeavyFluorinatedDraconiumSolution = Builder("heavy_fluorinated_draconium_solution")
                .fluid()
                .color(0x8C117D)
                .buildAndRegister();
