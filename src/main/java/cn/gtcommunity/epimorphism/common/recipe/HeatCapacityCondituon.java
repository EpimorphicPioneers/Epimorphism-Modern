...
import cn.gtcommunity.epimorphism.common.machine.multiblock.electric.NanoscaleFabricatorMachine;
...
public class HeatCapacityCondituon extends RecipeCondition {
    ...
    public Component getTooltips() {
        return Component.translatable("recipe.condition.heat_capacity.desc", FormattingUtil.formatNumbers(heatCapacity));
    }
