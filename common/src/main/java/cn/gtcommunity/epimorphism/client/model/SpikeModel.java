...
//            quads.add(FaceQuad.builder(side, sideSprite).cube(new AABB(0.0F, 0.0F, 0.0F, 1.0F, 0.0625F, 1.0F)).cubeUV().tintIndex(0).bake());

            var builder = new Quad.Builder(sideSprite);
            builder.setQuadOrientation(side);
            builder.copyFrom(FaceQuad.builder(side, sideSprite).cube(new AABB(0.0F, 0.0F, 0.0F, 1.0F, 0.0625F, 1.0F)).cubeUV().tintIndex(0).bake(), 0);
        ...
        return quads;
//        quads.add(new BakedQuad()0.0F, 0.0F, 0.0F, 1.0F, 0.0625F, 1.0F).setTexture("spikes/spike_" + this.type.name() + "_base");
//        for(int i = 0; i < 4; ++i) {
//            model.add((new BoxSingleQuad(new UV[]{new UV(1.0F, 0.0625F, 0.0F, 0.0F, 0.0625F), new UV(0.0F, 0.0625F, 0.0F, 1.0F, 0.0625F), new UV(0.5F, 1.0F, 0.5F, 0.5F, 1.0F), new UV(0.5F, 1.0F, 0.5F, 0.5F, 1.0F)})).setDoubleSided(false).setTexture("spikes/spike_" + this.type.name() + "_side").rotateY(i));
//        }
