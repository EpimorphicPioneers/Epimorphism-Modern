...
public class EPItems {
    ...
    //  Boards
    public final static ItemEntry<ComponentItem> GOOWARE_BOARD = REGISTRATE.item("board.gooware", ComponentItem::create)
            .lang("Kapton™ Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.board.gooware.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> OPTICAL_BOARD = REGISTRATE.item("board.optical", ComponentItem::create)
            .lang("Gallium Nitride Semiconducting Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.board.optical.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> SPINTRONIC_BOARD = REGISTRATE.item("board.spintronic", ComponentItem::create)
            .lang("Carbon Nanotube Magnetic storage Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.board.spintronic.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> GOOWARE_CIRCUIT_BOARD = REGISTRATE.item("circuit_board.gooware", ComponentItem::create)
            .lang("Super Circuit Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.circuit_board.gooware.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> OPTICAL_CIRCUIT_BOARD = REGISTRATE.item("circuit_board.optical", ComponentItem::create)
            .lang("Ultimate Circuit Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.circuit_board.optical.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> SPINTRONIC_CIRCUIT_BOARD = REGISTRATE.item("circuit_board.spintronic", ComponentItem::create)
    ...
    //  Circuits
    public final static ItemEntry<ComponentItem> GOOWARE_PROCESSOR = REGISTRATE.item("circuit.gooware_processor", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> GOOWARE_ASSEMBLY = REGISTRATE.item("circuit.gooware_assembly", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> GOOWARE_COMPUTER = REGISTRATE.item("circuit.gooware_computer", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> GOOWARE_MAINFRAME = REGISTRATE.item("circuit.gooware_mainframe", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> OPTICAL_PROCESSOR = REGISTRATE.item("circuit.optical_processor", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> OPTICAL_ASSEMBLY = REGISTRATE.item("circuit.optical_assembly", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> OPTICAL_COMPUTER = REGISTRATE.item("circuit.optical_computer", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> OPTICAL_MAINFRAME = REGISTRATE.item("circuit.optical_mainframe", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> SPINTRONIC_PROCESSOR = REGISTRATE.item("circuit.spintronic_processor", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> SPINTRONIC_ASSEMBLY = REGISTRATE.item("circuit.spintronic_assembly", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> SPINTRONIC_COMPUTER = REGISTRATE.item("circuit.spintronic_computer", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> SPINTRONIC_MAINFRAME = REGISTRATE.item("circuit.spintronic_mainframe", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> COSMIC_PROCESSOR = REGISTRATE.item("circuit.cosmic_processor", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> COSMIC_ASSEMBLY = REGISTRATE.item("circuit.cosmic_assembly", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> COSMIC_COMPUTER = REGISTRATE.item("circuit.cosmic_computer", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> COSMIC_MAINFRAME = REGISTRATE.item("circuit.cosmic_mainframe", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> SUPRACAUSAL_PROCESSOR = REGISTRATE.item("circuit.supracausal_processor", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> SUPRACAUSAL_ASSEMBLY = REGISTRATE.item("circuit.supracausal_assembly", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> SUPRACAUSAL_COMPUTER = REGISTRATE.item("circuit.supracausal_computer", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> SUPRACAUSAL_MAINFRAME = REGISTRATE.item("circuit.supracausal_mainframe", ComponentItem::create)
    ...
    //  Components
    public final static ItemEntry<ComponentItem> OPTICAL_TRANSISTOR = REGISTRATE.item("component.optical_smd.transistor", ComponentItem::create)
            .lang("Phototransistor")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.optical_smd.transistor.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> OPTICAL_RESISTOR = REGISTRATE.item("component.optical_smd.resistor", ComponentItem::create)
            .lang("Photoresistor")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.optical_smd.resistor.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> OPTICAL_CAPACITOR = REGISTRATE.item("component.optical_smd.capacitor", ComponentItem::create)
            .lang("Optical Integrator")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.optical_smd.capacitor.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> OPTICAL_DIODE = REGISTRATE.item("component.optical_smd.diode", ComponentItem::create)
            .lang("Optical Isolator")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.optical_smd.diode.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> OPTICAL_INDUCTOR = REGISTRATE.item("component.optical_smd.inductor", ComponentItem::create)
            .lang("Optical Polarizer")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.optical_smd.inductor.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> SPINTRONIC_TRANSISTOR = REGISTRATE.item("component.spintronic_smd.transistor", ComponentItem::create)
            .lang("MOSFET")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.spintronic_smd.transistor.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> SPINTRONIC_RESISTOR = REGISTRATE.item("component.spintronic_smd.resistor", ComponentItem::create)
            .lang("Magnetoresistor")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.spintronic_smd.resistor.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> SPINTRONIC_CAPACITOR = REGISTRATE.item("component.spintronic_smd.capacitor", ComponentItem::create)
            .lang("Ultracapacitor")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.spintronic_smd.capacitor.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> SPINTRONIC_DIODE = REGISTRATE.item("component.spintronic_smd.diode", ComponentItem::create)
            .lang("Schottky Diode")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.spintronic_smd.diode.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> SPINTRONIC_INDUCTOR = REGISTRATE.item("component.spintronic_smd.inductor", ComponentItem::create)
            .lang("Spin Polarizer")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.spintronic_smd.inductor.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> COSMIC_TRANSISTOR = REGISTRATE.item("component.cosmic_smd.transistor", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> COSMIC_RESISTOR = REGISTRATE.item("component.cosmic_smd.resistor", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> COSMIC_CAPACITOR = REGISTRATE.item("component.cosmic_smd.capacitor", ComponentItem::create)
            .lang("Holographic Energy Charge")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.cosmic_smd.capacitor.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> COSMIC_DIODE = REGISTRATE.item("component.cosmic_smd.diode", ComponentItem::create)
            .lang("Cosmic Ion Diode")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.cosmic_smd.diode.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> COSMIC_INDUCTOR = REGISTRATE.item("component.cosmic_smd.inductor", ComponentItem::create)
            .lang("Zenith Polarizer")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.cosmic_smd.inductor.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> SUPRACAUSAL_TRANSISTOR = REGISTRATE.item("component.supracausal_smd.transistor", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> SUPRACAUSAL_RESISTOR = REGISTRATE.item("component.supracausal_smd.resistor", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> SUPRACAUSAL_CAPACITOR = REGISTRATE.item("component.supracausal_smd.capacitor", ComponentItem::create)
        ...
        lines.add(Component.translatable("item.epimorphism.component.supracausal_smd.capacitor.tooltip"));
            ...
            .register();
    public final static ItemEntry<ComponentItem> SUPRACAUSAL_DIODE = REGISTRATE.item("component.supracausal_smd.diode", ComponentItem::create)
            .lang("Spin network Carrier Diode")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.supracausal_smd.diode.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> SUPRACAUSAL_INDUCTOR = REGISTRATE.item("component.supracausal_smd.inductor", ComponentItem::create)
    ...
    //  Gooware Components
    public final static ItemEntry<ComponentItem> BZ_REACTION_CHAMBER = REGISTRATE.item("component.gooware.reaction_chamber", ComponentItem::create)
            .lang("Belousov-Zhabotinsky Reaction Chamber")
            .register();
    public final static ItemEntry<ComponentItem> NONLINEAR_CHEMICAL_OSCILLATOR = REGISTRATE.item("component.gooware.nonlinear_chemical_oscillator", ComponentItem::create)
    ...
    //  Optical Components
    public final static ItemEntry<ComponentItem> OPTICAL_LASER_CONTROL_UNIT = REGISTRATE.item("component.optical.optical_laser_control_unit", ComponentItem::create)
    ...
    public final static ItemEntry<ComponentItem> ESR_COMPUTATION_UNIT = REGISTRATE.item("component.spintronic.esr_computation_unit", ComponentItem::create)
    ...
    //  Cosmic Components
    public final static ItemEntry<ComponentItem> COSMIC_INFORMATION_MODULE = REGISTRATE.item("component.cosmic.information_module", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> HOLOGRAPHIC_INFORMATION_IMC = REGISTRATE.item("component.cosmic.holographic_imc", ComponentItem::create)
    ...
    public final static ItemEntry<ComponentItem> SPACETIME_CONDENSER = REGISTRATE.item("component.supracausal.spacetime_condenser", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> LIGHT_CONE_MODULE = REGISTRATE.item("component.supracausal.light_cone_module", ComponentItem::create)
    ...
    //  Lasers
    public final static ItemEntry<ComponentItem> OPTICAL_FIBER = REGISTRATE.item("laser.optical_fiber", ComponentItem::create)
            .lang("Optical Fiber")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.laser.optical_fiber.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> DIELECTRIC_MIRROR = REGISTRATE.item("laser.dielectric_mirror", ComponentItem::create)
            .lang("Dielectric Mirror")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.laser.dielectric_mirror.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> EMPTY_LASER_ASSEMBLY = REGISTRATE.item("laser.emitter.empty", ComponentItem::create)
            .lang("Empty Laser Assembly")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.laser.emitter.empty.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> HELIUM_LASER = REGISTRATE.item("laser.emitter.helium", ComponentItem::create)
            .lang("Helium Laser Emitter")
            .register();
    public final static ItemEntry<ComponentItem> NEON_LASER = REGISTRATE.item("laser.emitter.neon", ComponentItem::create)
            .lang("Neon Laser Emitter")
            .register();
    public final static ItemEntry<ComponentItem> ARGON_LASER = REGISTRATE.item("laser.emitter.argon", ComponentItem::create)
            .lang("Argon Laser Emitter")
            .register();
    public final static ItemEntry<ComponentItem> KRYPTON_LASER = REGISTRATE.item("laser.emitter.krypton", ComponentItem::create)
            .lang("Krypton Laser Emitter")
            .register();
    public final static ItemEntry<ComponentItem> XENON_LASER = REGISTRATE.item("laser.emitter.xenon", ComponentItem::create)
            .lang("Xenon Laser Emitter")
            .register();
    public final static ItemEntry<ComponentItem> HELIUM_NEON_LASER = REGISTRATE.item("laser.emitter.helium_neon", ComponentItem::create)
            .lang("Helium-Neon Laser")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.laser.emitter.helium_neon.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> ND_YAG_LASER = REGISTRATE.item("laser.emitter.nd_yag", ComponentItem::create)
    ...
    public final static ItemEntry<ComponentItem> TOPOLOGICAL_INSULATOR_TUBE = REGISTRATE.item("tube.topological_insulator", ComponentItem::create)
            .lang("Topological Insulator Tube")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.tube.topological_insulator.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> BOSE_EINSTEIN_CONDENSATE_CONTAINMENT_UNIT = REGISTRATE.item("containment_unit.bose_einstein_condensate", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> BOSE_EINSTEIN_CONDENSATE = REGISTRATE.item("bose_einstein_condensate", ComponentItem::create)
    ...
    //  Wafers
    public final static ItemEntry<ComponentItem> PHASE_CHANGE_MEMORY = REGISTRATE.item("wafer.chip.phase_change_memory", ComponentItem::create)
            .lang("PRAM")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.chip.phase_change_memory.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> OPTICAL_NOR_MEMORY_CHIP = REGISTRATE.item("wafer.chip.optical_nor_memory_chip", ComponentItem::create)
            .lang("ACNOR")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.chip.optical_nor_memory_chip.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> SPIN_TRANSFER_TORQUE_MEMORY = REGISTRATE.item("wafer.chip.spin_transfer_torque_memory", ComponentItem::create)
            .lang("STTRAM")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.chip.spin_transfer_torque_memory.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> SPINTRONIC_NAND_MEMORY_CHIP = REGISTRATE.item("wafer.chip.spintronic_nand_memory_chip", ComponentItem::create)
            .lang("MDNAND")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.chip.spintronic_nand_memory_chip.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> NANO_PIC_WAFER = REGISTRATE.item("wafer.nano_pic", ComponentItem::create)
            .lang("NPIC Wafer")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.nano_pic.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> NANO_PIC_CHIP = REGISTRATE.item("wafer.chip.nano_pic", ComponentItem::create)
            .lang("NPIC")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.chip.nano_pic.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> PICO_PIC_WAFER = REGISTRATE.item("wafer.pico_pic", ComponentItem::create)
            .lang("PPIC Wafer")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.pico_pic.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> PICO_PIC_CHIP = REGISTRATE.item("wafer.chip.pico_pic", ComponentItem::create)
            .lang("PPIC")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.chip.pico_pic.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> FEMTO_PIC_WAFER = REGISTRATE.item("wafer.femto_pic", ComponentItem::create)
            .lang("FPIC Wafer")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.femto_pic.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> FEMTO_PIC_CHIP = REGISTRATE.item("wafer.chip.femto_pic", ComponentItem::create)
            .lang("FPIC")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.chip.femto_pic.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> ATTO_PIC_WAFER = REGISTRATE.item("wafer.atto_pic", ComponentItem::create)
            .lang("APIC Wafer")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.atto_pic.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> ATTO_PIC_CHIP = REGISTRATE.item("wafer.chip.atto_pic", ComponentItem::create)
            .lang("APIC")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.chip.atto_pic.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> ZEPTO_PIC_WAFER = REGISTRATE.item("wafer.zepto_pic", ComponentItem::create)
            .lang("ZPIC Wafer")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.zepto_pic.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> ZEPTO_PIC_CHIP = REGISTRATE.item("wafer.chip.zepto_pic", ComponentItem::create)
            .lang("ZPIC")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.chip.zepto_pic.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> DUBNIUM_BOULE = REGISTRATE.item("boule.dubnium", ComponentItem::create)
            .lang("Dubnium-doped Monocrystalline Silicon Boule")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.boule.dubnium.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> DUBNIUM_WAFER = REGISTRATE.item("wafer.dubnium", ComponentItem::create)
            .lang("Dubnium-doped Wafer")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.dubnium.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> CUBIC_ZIRCONIA_EUROPIUM_BOULE = REGISTRATE.item("boule.cubic_zirconia.europium", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> CUBIC_ZIRCONIA_EUROPIUM_WAFER = REGISTRATE.item("wafer.cubic_zirconia.europium", ComponentItem::create)
            ...
            .register();
    public final static ItemEntry<ComponentItem> CRYSTAL_INTERFACE_WAFER = REGISTRATE.item("wafer.crystal_interface", ComponentItem::create)
            .lang("Crystal Interface Wafer")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.crystal_interface.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> CRYSTAL_INTERFACE_CHIP = REGISTRATE.item("wafer.chip.crystal_interface", ComponentItem::create)
            .lang("Infinite Circuit Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.chip.crystal_interface.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> UHASOC_WAFER = REGISTRATE.item("wafer.uhasoc", ComponentItem::create)
            .lang("Infinite Circuit Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.uhasoc.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> UHASOC_CHIP = REGISTRATE.item("wafer.chip.uhasoc", ComponentItem::create)
            .lang("Infinite Circuit Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.chip.uhasoc.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> INTRAVITAL_SOC = REGISTRATE.item("component.gooware.intravital_soc", ComponentItem::create)
            .lang("Infinite Circuit Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.gooware.intravital_soc.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> STRONTIUM_CARBONATE_BOHRIUM_BOULE = REGISTRATE.item("boule.strontium_carbonate.bohrium", ComponentItem::create)
            .lang("Infinite Circuit Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.boule.strontium_carbonate.bohrium.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> STRONTIUM_CARBONATE_BOHRIUM_WAFER = REGISTRATE.item("wafer.strontium_carbonate.bohrium", ComponentItem::create)
            .lang("Infinite Circuit Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.wafer.strontium_carbonate.bohrium.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> STRONTIUM_CARBONATE_OPTICAL_WAFER = REGISTRATE.item("component.optical.strontium_carbonate_wafer", ComponentItem::create)
            .lang("Infinite Circuit Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.optical.strontium_carbonate_wafer.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> OPTICAL_IMC_BOARD = REGISTRATE.item("component.optical.optical_imc_board", ComponentItem::create)
            .lang("Infinite Circuit Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("item.epimorphism.component.optical.optical_imc_board.tooltip"));
            })))
            .register();
    public final static ItemEntry<ComponentItem> PHOTOELECTRON_SOC  = REGISTRATE.item("component.optical.photoelectron_soc", ComponentItem::create)
            .lang("Infinite Circuit Board")
            .onRegister(attach(new TooltipBehavior(lines -> {
...
//
//    //  Covers
//    public final static ItemEntry<Item> ELECTRIC_MOTOR_ULV;
//    public final static ItemEntry<Item> ELECTRIC_PISTON_ULV;
//    public final static ItemEntry<Item> ELECTRIC_PUMP_ULV;
//    public final static ItemEntry<Item> CONVEYOR_MODULE_ULV;
//    public final static ItemEntry<Item> ROBOT_ARM_ULV;
//    public final static ItemEntry<Item> EMITTER_ULV;
//    public final static ItemEntry<Item> SENSOR_ULV;
//    public final static ItemEntry<Item> FIELD_GENERATOR_ULV;
//    public final static ItemEntry<Item> ELECTRIC_MOTOR_MAX;
//    public final static ItemEntry<Item> ELECTRIC_PISTON_MAX;
//    public final static ItemEntry<Item> ELECTRIC_PUMP_MAX;
//    public final static ItemEntry<Item> CONVEYOR_MODULE_MAX;
//    public final static ItemEntry<Item> ROBOT_ARM_MAX;
//    public final static ItemEntry<Item> EMITTER_MAX;
//    public final static ItemEntry<Item> SENSOR_MAX;
//    public final static ItemEntry<Item> FIELD_GENERATOR_MAX;
//
...
//    public final static ItemEntry<Item> BROWN_ALGA;
        ...
        //  Wrap Circuits
        public final static ItemEntry<Item> WRAP_CIRCUIT_ULV = REGISTRATE.item("wrap.circuit.ulv", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_LV = REGISTRATE.item("wrap.circuit.lv", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_MV = REGISTRATE.item("wrap.circuit.mv", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_HV = REGISTRATE.item("wrap.circuit.hv", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_EV = REGISTRATE.item("wrap.circuit.ev", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_IV = REGISTRATE.item("wrap.circuit.iv", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_LuV = REGISTRATE.item("wrap.circuit.luv", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_ZPM = REGISTRATE.item("wrap.circuit.zpm", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_UV = REGISTRATE.item("wrap.circuit.uv", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_UHV = REGISTRATE.item("wrap.circuit.uhv", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_UEV = REGISTRATE.item("wrap.circuit.uev", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_UIV = REGISTRATE.item("wrap.circuit.uiv", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_UXV = REGISTRATE.item("wrap.circuit.uxv", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_OpV = REGISTRATE.item("wrap.circuit.opv", Item::new)
                .lang("Infinite Circuit Board")
                .register();
        public final static ItemEntry<Item> WRAP_CIRCUIT_MAX = REGISTRATE.item("wrap.circuit.max", Item::new)
                .lang("Infinite Circuit Board")
                .register();
//    //  Debug
