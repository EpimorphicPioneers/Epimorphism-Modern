...
import static net.minecraft.core.registries.BuiltInRegistries.FLUID;

public class EPTransformUtil {
    private static final Fluid EMPTY = FLUID.get(FLUID.getDefaultKey());
    ...
    public static String fluidToString(Fluid fluid) {
        return FLUID.getKey(fluid).toString();
    }
