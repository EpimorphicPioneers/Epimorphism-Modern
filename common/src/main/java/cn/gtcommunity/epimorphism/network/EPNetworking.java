...
import static com.lowdragmc.lowdraglib.networking.LDLNetworking.*;

public class EPNetworking {
    public static final INetworking NETWORK = createNetworking(Epimorphism.id("networking"), "0.0.1");
